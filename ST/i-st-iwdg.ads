...
package Interfaces.ST.IWDG is
   ...
   subtype KR_KEY_Field is Interfaces.ST.UInt16;
   ...
   subtype PR_PR_Field is Interfaces.ST.UInt3;
   ...
   subtype RLR_RL_Field is Interfaces.ST.UInt12;
   ...
   subtype SR_PVU_Field is Interfaces.ST.Bit;
   subtype SR_RVU_Field is Interfaces.ST.Bit;
