...
package Interfaces.ST.NVIC is
   ...
   subtype ICTR_INTLINESNUM_Field is Interfaces.ST.UInt4;
   ...
   type ICTR_Register is record
      ...
      --  unspecified
      Reserved_4_31 : Interfaces.ST.UInt28;
   end record
   ...
   subtype IPR_IPR_N_Element is Interfaces.ST.Byte;
   ...
   subtype STIR_INTID_Field is Interfaces.ST.UInt9;
   ...
   type NVIC_Peripheral is record
      ...
      ISER0 : aliased Interfaces.ST.UInt32;
      --  Interrupt Set-Enable Register
      ISER1 : aliased Interfaces.ST.UInt32;
      --  Interrupt Set-Enable Register
      ISER2 : aliased Interfaces.ST.UInt32;
      --  Interrupt Clear-Enable Register
      ICER0 : aliased Interfaces.ST.UInt32;
      --  Interrupt Clear-Enable Register
      ICER1 : aliased Interfaces.ST.UInt32;
      --  Interrupt Clear-Enable Register
      ICER2 : aliased Interfaces.ST.UInt32;
      --  Interrupt Set-Pending Register
      ISPR0 : aliased Interfaces.ST.UInt32;
      --  Interrupt Set-Pending Register
      ISPR1 : aliased Interfaces.ST.UInt32;
      --  Interrupt Set-Pending Register
      ISPR2 : aliased Interfaces.ST.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR0 : aliased Interfaces.ST.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR1 : aliased Interfaces.ST.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR2 : aliased Interfaces.ST.UInt32;
      --  Interrupt Active Bit Register
      IABR0 : aliased Interfaces.ST.UInt32;
      --  Interrupt Active Bit Register
      IABR1 : aliased Interfaces.ST.UInt32;
      --  Interrupt Active Bit Register
      IABR2 : aliased Interfaces.ST.UInt32;
      --  Interrupt Priority Register
