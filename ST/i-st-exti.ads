...
package Interfaces.ST.EXTI is
   ...
   subtype IMR_MR_Element is Interfaces.ST.Bit;
   ...
   subtype EMR_MR_Element is Interfaces.ST.Bit;
   ...
   subtype RTSR_TR_Element is Interfaces.ST.Bit;
   ...
   subtype FTSR_TR_Element is Interfaces.ST.Bit;
   ...
   --  SWIER array element
   subtype SWIER_Element is Interfaces.ST.Bit;
   ...
   --  PR array element
   subtype PR_Element is Interfaces.ST.Bit;
