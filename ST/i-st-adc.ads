...
package Interfaces.ST.ADC is
   ...
   subtype SR_AWD_Field is Interfaces.ST.Bit;
   subtype SR_EOC_Field is Interfaces.ST.Bit;
   subtype SR_JEOC_Field is Interfaces.ST.Bit;
   subtype SR_JSTRT_Field is Interfaces.ST.Bit;
   subtype SR_STRT_Field is Interfaces.ST.Bit;
   subtype SR_OVR_Field is Interfaces.ST.Bit;
   ...
   subtype CR1_AWDCH_Field is Interfaces.ST.UInt5;
   subtype CR1_EOCIE_Field is Interfaces.ST.Bit;
   subtype CR1_AWDIE_Field is Interfaces.ST.Bit;
   subtype CR1_JEOCIE_Field is Interfaces.ST.Bit;
   subtype CR1_SCAN_Field is Interfaces.ST.Bit;
   subtype CR1_AWDSGL_Field is Interfaces.ST.Bit;
   subtype CR1_JAUTO_Field is Interfaces.ST.Bit;
   subtype CR1_DISCEN_Field is Interfaces.ST.Bit;
   subtype CR1_JDISCEN_Field is Interfaces.ST.Bit;
   subtype CR1_DISCNUM_Field is Interfaces.ST.UInt3;
   subtype CR1_JAWDEN_Field is Interfaces.ST.Bit;
   subtype CR1_AWDEN_Field is Interfaces.ST.Bit;
   subtype CR1_RES_Field is Interfaces.ST.UInt2;
   subtype CR1_OVRIE_Field is Interfaces.ST.Bit;
   ...
   type CR1_Register is record
      ...
      --  unspecified
      Reserved_16_21 : Interfaces.ST.UInt6 := 16#0#;
   ...
   subtype CR2_ADON_Field is Interfaces.ST.Bit;
   subtype CR2_CONT_Field is Interfaces.ST.Bit;
   subtype CR2_DMA_Field is Interfaces.ST.Bit;
   subtype CR2_DDS_Field is Interfaces.ST.Bit;
   subtype CR2_EOCS_Field is Interfaces.ST.Bit;
   subtype CR2_ALIGN_Field is Interfaces.ST.Bit;
   subtype CR2_JEXTSEL_Field is Interfaces.ST.UInt4;
   subtype CR2_JEXTEN_Field is Interfaces.ST.UInt2;
   subtype CR2_JSWSTART_Field is Interfaces.ST.Bit;
   subtype CR2_EXTSEL_Field is Interfaces.ST.UInt4;
   subtype CR2_EXTEN_Field is Interfaces.ST.UInt2;
   subtype CR2_SWSTART_Field is Interfaces.ST.Bit;
   ...
   subtype SMPR1_SMP_Element is Interfaces.ST.UInt3;
   ...
   subtype SMPR2_SMP_Element is Interfaces.ST.UInt3;
   ...
   subtype JOFR1_JOFFSET1_Field is Interfaces.ST.UInt12;
   ...
   subtype JOFR2_JOFFSET2_Field is Interfaces.ST.UInt12;
   ...
   subtype JOFR3_JOFFSET3_Field is Interfaces.ST.UInt12;
   ...
   subtype JOFR4_JOFFSET4_Field is Interfaces.ST.UInt12;
   ...
   subtype HTR_HT_Field is Interfaces.ST.UInt12;
   ...
   subtype LTR_LT_Field is Interfaces.ST.UInt12;
   ...
   subtype SQR1_SQ_Element is Interfaces.ST.UInt5;
   ...
   subtype SQR1_L_Field is Interfaces.ST.UInt4;
   ...
   subtype SQR2_SQ_Element is Interfaces.ST.UInt5;
   ...
   subtype SQR3_SQ_Element is Interfaces.ST.UInt5;
   ...
   subtype JSQR_JSQ_Element is Interfaces.ST.UInt5;
   ...
   subtype JSQR_JL_Field is Interfaces.ST.UInt2;
   ...
   subtype JDR_JDATA_Field is Interfaces.ST.UInt16;
   ...
   subtype DR_DATA_Field is Interfaces.ST.UInt16;
   ...
   subtype CSR_AWD1_Field is Interfaces.ST.Bit;
   subtype CSR_EOC1_Field is Interfaces.ST.Bit;
   subtype CSR_JEOC1_Field is Interfaces.ST.Bit;
   subtype CSR_JSTRT1_Field is Interfaces.ST.Bit;
   subtype CSR_STRT1_Field is Interfaces.ST.Bit;
   subtype CSR_OVR1_Field is Interfaces.ST.Bit;
   subtype CSR_AWD2_Field is Interfaces.ST.Bit;
   subtype CSR_EOC2_Field is Interfaces.ST.Bit;
   subtype CSR_JEOC2_Field is Interfaces.ST.Bit;
   subtype CSR_JSTRT2_Field is Interfaces.ST.Bit;
   subtype CSR_STRT2_Field is Interfaces.ST.Bit;
   subtype CSR_OVR2_Field is Interfaces.ST.Bit;
   subtype CSR_AWD3_Field is Interfaces.ST.Bit;
   subtype CSR_EOC3_Field is Interfaces.ST.Bit;
   subtype CSR_JEOC3_Field is Interfaces.ST.Bit;
   subtype CSR_JSTRT3_Field is Interfaces.ST.Bit;
   subtype CSR_STRT3_Field is Interfaces.ST.Bit;
   subtype CSR_OVR3_Field is Interfaces.ST.Bit;
   ...
   type CSR_Register is record
      ...
      OVR2           : CSR_OVR2_Field;
      --  unspecified
      Reserved_14_15 : Interfaces.ST.UInt2;
   ...
   subtype CCR_MULT_Field is Interfaces.ST.UInt5;
   subtype CCR_DELAY_Field is Interfaces.ST.UInt4;
   subtype CCR_DDS_Field is Interfaces.ST.Bit;
   subtype CCR_DMA_Field is Interfaces.ST.UInt2;
   subtype CCR_ADCPRE_Field is Interfaces.ST.UInt2;
   subtype CCR_VBATE_Field is Interfaces.ST.Bit;
   subtype CCR_TSVREFE_Field is Interfaces.ST.Bit;
   ...
   type CCR_Register is record
      ...
      --  unspecified
      Reserved_12_12 : Interfaces.ST.Bit := 16#0#;
   ...
   subtype CDR_DATA_Element is Interfaces.ST.UInt16;
