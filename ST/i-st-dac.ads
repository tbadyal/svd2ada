...
package Interfaces.ST.DAC is
   ...
   subtype CR_EN1_Field is Interfaces.ST.Bit;
   subtype CR_BOFF1_Field is Interfaces.ST.Bit;
   subtype CR_TEN1_Field is Interfaces.ST.Bit;
   subtype CR_TSEL1_Field is Interfaces.ST.UInt3;
   subtype CR_WAVE1_Field is Interfaces.ST.UInt2;
   subtype CR_MAMP1_Field is Interfaces.ST.UInt4;
   subtype CR_DMAEN1_Field is Interfaces.ST.Bit;
   subtype CR_DMAUDRIE1_Field is Interfaces.ST.Bit;
   subtype CR_EN2_Field is Interfaces.ST.Bit;
   subtype CR_BOFF2_Field is Interfaces.ST.Bit;
   subtype CR_TEN2_Field is Interfaces.ST.Bit;
   subtype CR_TSEL2_Field is Interfaces.ST.UInt3;
   subtype CR_WAVE2_Field is Interfaces.ST.UInt2;
   subtype CR_MAMP2_Field is Interfaces.ST.UInt4;
   subtype CR_DMAEN2_Field is Interfaces.ST.Bit;
   subtype CR_DMAUDRIE2_Field is Interfaces.ST.Bit;
   ...
   subtype SWTRIGR_SWTRIG_Element is Interfaces.ST.Bit;
   ...
   subtype DHR12R1_DACC1DHR_Field is Interfaces.ST.UInt12;
   ...
   subtype DHR12L1_DACC1DHR_Field is Interfaces.ST.UInt12;
   ...
   subtype DHR8R1_DACC1DHR_Field is Interfaces.ST.Byte;
   ...
   subtype DHR12R2_DACC2DHR_Field is Interfaces.ST.UInt12;
   ...
   subtype DHR12L2_DACC2DHR_Field is Interfaces.ST.UInt12;
   ...
   subtype DHR8R2_DACC2DHR_Field is Interfaces.ST.Byte;
   ...
   subtype DHR12RD_DACC1DHR_Field is Interfaces.ST.UInt12;
   subtype DHR12RD_DACC2DHR_Field is Interfaces.ST.UInt12;
   ...
   subtype DHR12LD_DACC1DHR_Field is Interfaces.ST.UInt12;
   subtype DHR12LD_DACC2DHR_Field is Interfaces.ST.UInt12;
   ...
   type DHR12LD_Register is record
      ...
      --  unspecified
      Reserved_16_19 : Interfaces.ST.UInt4 := 16#0#;
      --  DAC channel2 12-bit left-aligned data
   ...
   subtype DHR8RD_DACC1DHR_Field is Interfaces.ST.Byte;
   subtype DHR8RD_DACC2DHR_Field is Interfaces.ST.Byte;
   ...
   subtype DOR1_DACC1DOR_Field is Interfaces.ST.UInt12;
   ...
   type DOR1_Register is record
      ...
      --  unspecified
      Reserved_12_31 : Interfaces.ST.UInt20;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DOR2_DACC2DOR_Field is Interfaces.ST.UInt12;
   ...
   subtype SR_DMAUDR1_Field is Interfaces.ST.Bit;
   subtype SR_DMAUDR2_Field is Interfaces.ST.Bit;

   --  status register
   type SR_Register is record
      --  unspecified
      Reserved_0_12  : Interfaces.ST.UInt13 := 16#0#;
