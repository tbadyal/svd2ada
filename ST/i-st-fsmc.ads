...
package Interfaces.ST.FSMC is
   ...
   subtype BCR1_MBKEN_Field is Interfaces.ST.Bit;
   subtype BCR1_MUXEN_Field is Interfaces.ST.Bit;
   subtype BCR1_MTYP_Field is Interfaces.ST.UInt2;
   subtype BCR1_MWID_Field is Interfaces.ST.UInt2;
   subtype BCR1_FACCEN_Field is Interfaces.ST.Bit;
   subtype BCR1_BURSTEN_Field is Interfaces.ST.Bit;
   subtype BCR1_WAITPOL_Field is Interfaces.ST.Bit;
   subtype BCR1_WAITCFG_Field is Interfaces.ST.Bit;
   subtype BCR1_WREN_Field is Interfaces.ST.Bit;
   subtype BCR1_WAITEN_Field is Interfaces.ST.Bit;
   subtype BCR1_EXTMOD_Field is Interfaces.ST.Bit;
   subtype BCR1_ASYNCWAIT_Field is Interfaces.ST.Bit;
   subtype BCR1_CBURSTRW_Field is Interfaces.ST.Bit;
   ...
   type BCR1_Register is record
      ...
      --  unspecified
      Reserved_7_7   : Interfaces.ST.Bit := 16#1#;
      --  BURSTEN
      ...
      --  unspecified
      Reserved_16_18 : Interfaces.ST.UInt3 := 16#0#;
      --  CBURSTRW
   ...
   subtype BTR_ADDSET_Field is Interfaces.ST.UInt4;
   subtype BTR_ADDHLD_Field is Interfaces.ST.UInt4;
   subtype BTR_DATAST_Field is Interfaces.ST.Byte;
   subtype BTR_BUSTURN_Field is Interfaces.ST.UInt4;
   subtype BTR_CLKDIV_Field is Interfaces.ST.UInt4;
   subtype BTR_DATLAT_Field is Interfaces.ST.UInt4;
   subtype BTR_ACCMOD_Field is Interfaces.ST.UInt2;
   ...
   type BTR_Register is record
      ...
      --  unspecified
      Reserved_30_31 : Interfaces.ST.UInt2 := 16#3#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype BCR_MBKEN_Field is Interfaces.ST.Bit;
   subtype BCR_MUXEN_Field is Interfaces.ST.Bit;
   subtype BCR_MTYP_Field is Interfaces.ST.UInt2;
   subtype BCR_MWID_Field is Interfaces.ST.UInt2;
   subtype BCR_FACCEN_Field is Interfaces.ST.Bit;
   subtype BCR_BURSTEN_Field is Interfaces.ST.Bit;
   subtype BCR_WAITPOL_Field is Interfaces.ST.Bit;
   subtype BCR_WRAPMOD_Field is Interfaces.ST.Bit;
   subtype BCR_WAITCFG_Field is Interfaces.ST.Bit;
   subtype BCR_WREN_Field is Interfaces.ST.Bit;
   subtype BCR_WAITEN_Field is Interfaces.ST.Bit;
   subtype BCR_EXTMOD_Field is Interfaces.ST.Bit;
   subtype BCR_ASYNCWAIT_Field is Interfaces.ST.Bit;
   subtype BCR_CBURSTRW_Field is Interfaces.ST.Bit;
   ...
   subtype PCR_PWAITEN_Field is Interfaces.ST.Bit;
   subtype PCR_PBKEN_Field is Interfaces.ST.Bit;
   subtype PCR_PTYP_Field is Interfaces.ST.Bit;
   subtype PCR_PWID_Field is Interfaces.ST.UInt2;
   subtype PCR_ECCEN_Field is Interfaces.ST.Bit;
   subtype PCR_TCLR_Field is Interfaces.ST.UInt4;
   subtype PCR_TAR_Field is Interfaces.ST.UInt4;
   subtype PCR_ECCPS_Field is Interfaces.ST.UInt3;
   ...
   subtype SR_IRS_Field is Interfaces.ST.Bit;
   subtype SR_ILS_Field is Interfaces.ST.Bit;
   subtype SR_IFS_Field is Interfaces.ST.Bit;
   subtype SR_IREN_Field is Interfaces.ST.Bit;
   subtype SR_ILEN_Field is Interfaces.ST.Bit;
   subtype SR_IFEN_Field is Interfaces.ST.Bit;
   subtype SR_FEMPT_Field is Interfaces.ST.Bit;
   ...
   subtype PMEM_MEMSETx_Field is Interfaces.ST.Byte;
   subtype PMEM_MEMWAITx_Field is Interfaces.ST.Byte;
   subtype PMEM_MEMHOLDx_Field is Interfaces.ST.Byte;
   subtype PMEM_MEMHIZx_Field is Interfaces.ST.Byte;
   ...
   subtype PATT_ATTSETx_Field is Interfaces.ST.Byte;
   subtype PATT_ATTWAITx_Field is Interfaces.ST.Byte;
   subtype PATT_ATTHOLDx_Field is Interfaces.ST.Byte;
   subtype PATT_ATTHIZx_Field is Interfaces.ST.Byte;
   ...
   subtype PIO4_IOSETx_Field is Interfaces.ST.Byte;
   subtype PIO4_IOWAITx_Field is Interfaces.ST.Byte;
   subtype PIO4_IOHOLDx_Field is Interfaces.ST.Byte;
   subtype PIO4_IOHIZx_Field is Interfaces.ST.Byte;
   ...
   subtype BWTR_ADDSET_Field is Interfaces.ST.UInt4;
   subtype BWTR_ADDHLD_Field is Interfaces.ST.UInt4;
   subtype BWTR_DATAST_Field is Interfaces.ST.Byte;
   subtype BWTR_CLKDIV_Field is Interfaces.ST.UInt4;
   subtype BWTR_DATLAT_Field is Interfaces.ST.UInt4;
   subtype BWTR_ACCMOD_Field is Interfaces.ST.UInt2;
   ...
   type BWTR_Register is record
      ...
      --  unspecified
      Reserved_16_19 : Interfaces.ST.UInt4 := 16#F#;
      --  CLKDIV
   ...
   type FSMC_Peripheral is record
      ...
      ECCR2 : aliased Interfaces.ST.UInt32;
      ...
      ECCR3 : aliased Interfaces.ST.UInt32;
