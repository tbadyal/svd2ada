...
package Interfaces.ST.DCMI is
   ...
   subtype CR_CAPTURE_Field is Interfaces.ST.Bit;
   subtype CR_CM_Field is Interfaces.ST.Bit;
   subtype CR_CROP_Field is Interfaces.ST.Bit;
   subtype CR_JPEG_Field is Interfaces.ST.Bit;
   subtype CR_ESS_Field is Interfaces.ST.Bit;
   subtype CR_PCKPOL_Field is Interfaces.ST.Bit;
   subtype CR_HSPOL_Field is Interfaces.ST.Bit;
   subtype CR_VSPOL_Field is Interfaces.ST.Bit;
   subtype CR_FCRC_Field is Interfaces.ST.UInt2;
   subtype CR_EDM_Field is Interfaces.ST.UInt2;
   subtype CR_ENABLE_Field is Interfaces.ST.Bit;
   ...
   subtype SR_HSYNC_Field is Interfaces.ST.Bit;
   subtype SR_VSYNC_Field is Interfaces.ST.Bit;
   subtype SR_FNE_Field is Interfaces.ST.Bit;
   ...
   type SR_Register is record
      ...
      FNE           : SR_FNE_Field;
      --  unspecified
      Reserved_3_31 : Interfaces.ST.UInt29;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RIS_FRAME_RIS_Field is Interfaces.ST.Bit;
   subtype RIS_OVR_RIS_Field is Interfaces.ST.Bit;
   subtype RIS_ERR_RIS_Field is Interfaces.ST.Bit;
   subtype RIS_VSYNC_RIS_Field is Interfaces.ST.Bit;
   subtype RIS_LINE_RIS_Field is Interfaces.ST.Bit;
   ...
   type RIS_Register is record
      ...
      --  unspecified
      Reserved_5_31 : Interfaces.ST.UInt27;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype IER_FRAME_IE_Field is Interfaces.ST.Bit;
   subtype IER_OVR_IE_Field is Interfaces.ST.Bit;
   subtype IER_ERR_IE_Field is Interfaces.ST.Bit;
   subtype IER_VSYNC_IE_Field is Interfaces.ST.Bit;
   subtype IER_LINE_IE_Field is Interfaces.ST.Bit;
   ...
   subtype MIS_FRAME_MIS_Field is Interfaces.ST.Bit;
   subtype MIS_OVR_MIS_Field is Interfaces.ST.Bit;
   subtype MIS_ERR_MIS_Field is Interfaces.ST.Bit;
   subtype MIS_VSYNC_MIS_Field is Interfaces.ST.Bit;
   subtype MIS_LINE_MIS_Field is Interfaces.ST.Bit;
   ...
   subtype ICR_FRAME_ISC_Field is Interfaces.ST.Bit;
   subtype ICR_OVR_ISC_Field is Interfaces.ST.Bit;
   subtype ICR_ERR_ISC_Field is Interfaces.ST.Bit;
   subtype ICR_VSYNC_ISC_Field is Interfaces.ST.Bit;
   subtype ICR_LINE_ISC_Field is Interfaces.ST.Bit;
   ...
   subtype ESCR_FSC_Field is Interfaces.ST.Byte;
   subtype ESCR_LSC_Field is Interfaces.ST.Byte;
   subtype ESCR_LEC_Field is Interfaces.ST.Byte;
   subtype ESCR_FEC_Field is Interfaces.ST.Byte;
   ...
   subtype ESUR_FSU_Field is Interfaces.ST.Byte;
   subtype ESUR_LSU_Field is Interfaces.ST.Byte;
   subtype ESUR_LEU_Field is Interfaces.ST.Byte;
   subtype ESUR_FEU_Field is Interfaces.ST.Byte;
   ...
   subtype CWSTRT_HOFFCNT_Field is Interfaces.ST.UInt14;
   subtype CWSTRT_VST_Field is Interfaces.ST.UInt13;
   ...
   subtype CWSIZE_CAPCNT_Field is Interfaces.ST.UInt14;
   subtype CWSIZE_VLINE_Field is Interfaces.ST.UInt14;
   ...
   subtype DR_Byte_Element is Interfaces.ST.Byte;
