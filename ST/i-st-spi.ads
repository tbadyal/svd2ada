...
package Interfaces.ST.SPI is
   ...
   subtype CR1_CPHA_Field is Interfaces.ST.Bit;
   subtype CR1_CPOL_Field is Interfaces.ST.Bit;
   subtype CR1_MSTR_Field is Interfaces.ST.Bit;
   subtype CR1_BR_Field is Interfaces.ST.UInt3;
   subtype CR1_SPE_Field is Interfaces.ST.Bit;
   subtype CR1_LSBFIRST_Field is Interfaces.ST.Bit;
   subtype CR1_SSI_Field is Interfaces.ST.Bit;
   subtype CR1_SSM_Field is Interfaces.ST.Bit;
   subtype CR1_RXONLY_Field is Interfaces.ST.Bit;
   subtype CR1_DFF_Field is Interfaces.ST.Bit;
   subtype CR1_CRCNEXT_Field is Interfaces.ST.Bit;
   subtype CR1_CRCEN_Field is Interfaces.ST.Bit;
   subtype CR1_BIDIOE_Field is Interfaces.ST.Bit;
   subtype CR1_BIDIMODE_Field is Interfaces.ST.Bit;
   ...
   subtype CR2_RXDMAEN_Field is Interfaces.ST.Bit;
   subtype CR2_TXDMAEN_Field is Interfaces.ST.Bit;
   subtype CR2_SSOE_Field is Interfaces.ST.Bit;
   subtype CR2_FRF_Field is Interfaces.ST.Bit;
   subtype CR2_ERRIE_Field is Interfaces.ST.Bit;
   subtype CR2_RXNEIE_Field is Interfaces.ST.Bit;
   subtype CR2_TXEIE_Field is Interfaces.ST.Bit;
   ...
   subtype SR_CHSIDE_Field is Interfaces.ST.Bit;
   subtype SR_UDR_Field is Interfaces.ST.Bit;
   subtype SR_CRCERR_Field is Interfaces.ST.Bit;
   subtype SR_MODF_Field is Interfaces.ST.Bit;
   subtype SR_OVR_Field is Interfaces.ST.Bit;
   subtype SR_BSY_Field is Interfaces.ST.Bit;
   subtype SR_TIFRFE_Field is Interfaces.ST.Bit;
   ...
   subtype DR_DR_Field is Interfaces.ST.UInt16;
   ...
   subtype CRCPR_CRCPOLY_Field is Interfaces.ST.UInt16;
   ...
   subtype RXCRCR_RxCRC_Field is Interfaces.ST.UInt16;
   ...
   subtype TXCRCR_TxCRC_Field is Interfaces.ST.UInt16;
   ...
   subtype I2SCFGR_CHLEN_Field is Interfaces.ST.Bit;
   subtype I2SCFGR_DATLEN_Field is Interfaces.ST.UInt2;
   subtype I2SCFGR_CKPOL_Field is Interfaces.ST.Bit;
   subtype I2SCFGR_I2SSTD_Field is Interfaces.ST.UInt2;
   subtype I2SCFGR_PCMSYNC_Field is Interfaces.ST.Bit;
   subtype I2SCFGR_I2SCFG_Field is Interfaces.ST.UInt2;
   subtype I2SCFGR_I2SE_Field is Interfaces.ST.Bit;
   subtype I2SCFGR_I2SMOD_Field is Interfaces.ST.Bit;
   ...
   subtype I2SPR_I2SDIV_Field is Interfaces.ST.Byte;
   subtype I2SPR_ODD_Field is Interfaces.ST.Bit;
   subtype I2SPR_MCKOE_Field is Interfaces.ST.Bit;
