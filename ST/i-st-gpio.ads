...
package Interfaces.ST.GPIO is
   ...
   --  MODER array element
   subtype MODER_Element is Interfaces.ST.UInt2;
   ...
   subtype OTYPER_OT_Element is Interfaces.ST.Bit;
   ...
   subtype OSPEEDR_Element is Interfaces.ST.UInt2;
   ...
   --  PUPDR array element
   subtype PUPDR_Element is Interfaces.ST.UInt2;
   ...
   --  IDR array element
   subtype IDR_Element is Interfaces.ST.Bit;
   ...
   --  ODR array element
   subtype ODR_Element is Interfaces.ST.Bit;
   ...
   subtype BSRR_BS_Element is Interfaces.ST.Bit;
   ...
   subtype BSRR_BR_Element is Interfaces.ST.Bit;
   ...
   subtype LCKR_LCK_Element is Interfaces.ST.Bit;
   ...
   subtype LCKR_LCKK_Field is Interfaces.ST.Bit;
   ...
   --  AFRL array element
   subtype AFRL_Element is Interfaces.ST.UInt4;
   ...
   --  AFRH array element
   subtype AFRH_Element is Interfaces.ST.UInt4;
