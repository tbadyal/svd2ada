...
package Interfaces.ST.USB_OTG_HS is
   pragma Preelaborate;
   ...
   subtype OTG_HS_DCFG_DSPD_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_DCFG_NZLSOHSK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DCFG_DAD_Field is Interfaces.ST.UInt7;
   subtype OTG_HS_DCFG_PFIVL_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_DCFG_PERSCHIVL_Field is Interfaces.ST.UInt2;
   ...
   subtype OTG_HS_DCTL_RWUSIG_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DCTL_SDIS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DCTL_GINSTS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DCTL_GONSTS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DCTL_TCTL_Field is Interfaces.ST.UInt3;
   subtype OTG_HS_DCTL_SGINAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DCTL_CGINAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DCTL_SGONAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DCTL_CGONAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DCTL_POPRGDNE_Field is Interfaces.ST.Bit;
   ...
   subtype OTG_HS_DSTS_SUSPSTS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DSTS_ENUMSPD_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_DSTS_EERR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DSTS_FNSOF_Field is Interfaces.ST.UInt14;
   ...
   subtype OTG_HS_DIEPMSK_XFRCM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPMSK_EPDM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPMSK_TOM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPMSK_ITTXFEMSK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPMSK_INEPNMM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPMSK_INEPNEM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPMSK_TXFURM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPMSK_BIM_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_DIEPMSK_Register is record
      ...
      --  unspecified
      Reserved_2_2   : Interfaces.ST.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_7_7   : Interfaces.ST.Bit := 16#0#;
      --  FIFO underrun mask
      TXFURM         : OTG_HS_DIEPMSK_TXFURM_Field := 16#0#;
      --  BNA interrupt mask
      BIM            : OTG_HS_DIEPMSK_BIM_Field := 16#0#;
      --  unspecified
      Reserved_10_31 : Interfaces.ST.UInt22 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DOEPMSK_XFRCM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPMSK_EPDM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPMSK_STUPM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPMSK_OTEPDM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPMSK_B2BSTUP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPMSK_OPEM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPMSK_BOIM_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_DOEPMSK_Register is record
      ...
      --  unspecified
      Reserved_5_5   : Interfaces.ST.Bit := 16#0#;
   ...
   subtype OTG_HS_DAINT_IEPINT_Field is Interfaces.ST.UInt16;
   subtype OTG_HS_DAINT_OEPINT_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_DAINTMSK_IEPM_Field is Interfaces.ST.UInt16;
   subtype OTG_HS_DAINTMSK_OEPM_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_DVBUSDIS_VBUSDT_Field is Interfaces.ST.UInt16;
   ...
   type OTG_HS_DVBUSDIS_Register is record
      ...
      --  unspecified
      Reserved_16_31 : Interfaces.ST.UInt16 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DVBUSPULSE_DVBUSP_Field is Interfaces.ST.UInt12;
   ...
   subtype OTG_HS_DTHRCTL_NONISOTHREN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DTHRCTL_ISOTHREN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DTHRCTL_TXTHRLEN_Field is Interfaces.ST.UInt9;
   subtype OTG_HS_DTHRCTL_RXTHREN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DTHRCTL_RXTHRLEN_Field is Interfaces.ST.UInt9;
   subtype OTG_HS_DTHRCTL_ARPEN_Field is Interfaces.ST.Bit;
   ...
   subtype OTG_HS_DIEPEMPMSK_INEPTXFEM_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_DEACHINT_IEP1INT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DEACHINT_OEP1INT_Field is Interfaces.ST.Bit;

   --  OTG_HS device each endpoint interrupt register
   type OTG_HS_DEACHINT_Register is record
      --  unspecified
      Reserved_0_0   : Interfaces.ST.Bit := 16#0#;
      --  IN endpoint 1interrupt bit
      IEP1INT        : OTG_HS_DEACHINT_IEP1INT_Field := 16#0#;
      --  unspecified
      Reserved_2_16  : Interfaces.ST.UInt15 := 16#0#;
      --  OUT endpoint 1 interrupt bit
      OEP1INT        : OTG_HS_DEACHINT_OEP1INT_Field := 16#0#;
      --  unspecified
      Reserved_18_31 : Interfaces.ST.UInt14 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DEACHINTMSK_IEP1INTM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DEACHINTMSK_OEP1INTM_Field is Interfaces.ST.Bit;
   ...
   subtype OTG_HS_DIEPEACHMSK1_XFRCM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPEACHMSK1_EPDM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPEACHMSK1_TOM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPEACHMSK1_ITTXFEMSK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPEACHMSK1_INEPNMM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPEACHMSK1_INEPNEM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPEACHMSK1_TXFURM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPEACHMSK1_BIM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPEACHMSK1_NAKM_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_DIEPEACHMSK1_Register is record
      ...
      --  unspecified
      Reserved_10_12 : Interfaces.ST.UInt3 := 16#0#;
      --  NAK interrupt mask
      NAKM           : OTG_HS_DIEPEACHMSK1_NAKM_Field := 16#0#;
      --  unspecified
      Reserved_14_31 : Interfaces.ST.UInt18 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DOEPEACHMSK1_XFRCM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPEACHMSK1_EPDM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPEACHMSK1_TOM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPEACHMSK1_ITTXFEMSK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPEACHMSK1_INEPNMM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPEACHMSK1_INEPNEM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPEACHMSK1_TXFURM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPEACHMSK1_BIM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPEACHMSK1_BERRM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPEACHMSK1_NAKM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPEACHMSK1_NYETM_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_DOEPEACHMSK1_Register is record
      ...
      --  unspecified
      Reserved_10_11 : Interfaces.ST.UInt2 := 16#0#;
   ...
   subtype OTG_HS_DIEPCTL_MPSIZ_Field is Interfaces.ST.UInt11;
   subtype OTG_HS_DIEPCTL_USBAEP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPCTL_EONUM_DPID_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPCTL_NAKSTS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPCTL_EPTYP_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_DIEPCTL_Stall_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPCTL_TXFNUM_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_DIEPCTL_CNAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPCTL_SNAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPCTL_SD0PID_SEVNFRM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPCTL_SODDFRM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPCTL_EPDIS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPCTL_EPENA_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_DIEPCTL_Register is record
      ...
      --  unspecified
      Reserved_11_14 : Interfaces.ST.UInt4 := 16#0#;
      --  USB active endpoint
      ...
      --  unspecified
      Reserved_20_20 : Interfaces.ST.Bit := 16#0#;
      --  STALL handshake
   ...
   subtype OTG_HS_DIEPINT_XFRC_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPINT_EPDISD_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPINT_TOC_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPINT_ITTXFE_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPINT_INEPNE_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPINT_TXFE_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPINT_TXFIFOUDRN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPINT_BNA_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPINT_PKTDRPSTS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPINT_BERR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DIEPINT_NAK_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_DIEPINT_Register is record
      ...
      --  unspecified
      Reserved_10_10 : Interfaces.ST.Bit := 16#0#;
   ...
   subtype OTG_HS_DIEPTSIZ0_XFRSIZ_Field is Interfaces.ST.UInt7;
   subtype OTG_HS_DIEPTSIZ0_PKTCNT_Field is Interfaces.ST.UInt2;
   ...
   type OTG_HS_DIEPTSIZ0_Register is record
      ...
      --  unspecified
      Reserved_7_18  : Interfaces.ST.UInt12 := 16#0#;
      --  Packet count
   ...
   subtype OTG_HS_DTXFSTS_INEPTFSAV_Field is Interfaces.ST.UInt16;
   ...
   type OTG_HS_DTXFSTS_Register is record
      ...
      --  unspecified
      Reserved_16_31 : Interfaces.ST.UInt16;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DIEPTSIZ_XFRSIZ_Field is Interfaces.ST.UInt19;
   subtype OTG_HS_DIEPTSIZ_PKTCNT_Field is Interfaces.ST.UInt10;
   subtype OTG_HS_DIEPTSIZ_MCNT_Field is Interfaces.ST.UInt2;
   ...
   type OTG_HS_DIEPTSIZ_Register is record
      ...
      --  unspecified
      Reserved_31_31 : Interfaces.ST.Bit := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DOEPCTL0_MPSIZ_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_DOEPCTL0_USBAEP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL0_NAKSTS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL0_EPTYP_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_DOEPCTL0_SNPM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL0_Stall_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL0_CNAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL0_SNAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL0_EPDIS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL0_EPENA_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_DOEPCTL0_Register is record
      ...
      --  unspecified
      Reserved_2_14  : Interfaces.ST.UInt13 := 16#0#;
      --  Read-only. USB active endpoint
      USBAEP         : OTG_HS_DOEPCTL0_USBAEP_Field := 16#1#;
      --  unspecified
      Reserved_16_16 : Interfaces.ST.Bit := 16#0#;
      --  Read-only. NAK status
      ...
      --  unspecified
      Reserved_22_25 : Interfaces.ST.UInt4 := 16#0#;
      --  Write-only. Clear NAK
      CNAK           : OTG_HS_DOEPCTL0_CNAK_Field := 16#0#;
      --  Write-only. Set NAK
      SNAK           : OTG_HS_DOEPCTL0_SNAK_Field := 16#0#;
      --  unspecified
      Reserved_28_29 : Interfaces.ST.UInt2 := 16#0#;
   ...
   subtype OTG_HS_DOEPINT_XFRC_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPINT_EPDISD_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPINT_STUP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPINT_OTEPDIS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPINT_B2BSTUP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPINT_NYET_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_DOEPINT_Register is record
      ...
      --  unspecified
      Reserved_7_13  : Interfaces.ST.UInt7 := 16#1#;
      --  NYET interrupt
   ...
   subtype OTG_HS_DOEPTSIZ0_XFRSIZ_Field is Interfaces.ST.UInt7;
   subtype OTG_HS_DOEPTSIZ0_PKTCNT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPTSIZ0_STUPCNT_Field is Interfaces.ST.UInt2;
   ...
   type OTG_HS_DOEPTSIZ0_Register is record
      ...
      --  unspecified
      Reserved_20_28 : Interfaces.ST.UInt9 := 16#0#;
      --  SETUP packet count
   ...
   subtype OTG_HS_DOEPCTL_MPSIZ_Field is Interfaces.ST.UInt11;
   subtype OTG_HS_DOEPCTL_USBAEP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL_EONUM_DPID_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL_NAKSTS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL_EPTYP_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_DOEPCTL_SNPM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL_Stall_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL_CNAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL_SNAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL_SD0PID_SEVNFRM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL_SODDFRM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL_EPDIS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_DOEPCTL_EPENA_Field is Interfaces.ST.Bit;
   ...
   subtype OTG_HS_DOEPTSIZ_XFRSIZ_Field is Interfaces.ST.UInt19;
   subtype OTG_HS_DOEPTSIZ_PKTCNT_Field is Interfaces.ST.UInt10;
   subtype OTG_HS_DOEPTSIZ_RXDPID_STUPCNT_Field is Interfaces.ST.UInt2;
   ...
   subtype OTG_HS_GOTGCTL_SRQSCS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGCTL_SRQ_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGCTL_HNGSCS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGCTL_HNPRQ_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGCTL_HSHNPEN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGCTL_DHNPEN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGCTL_CIDSTS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGCTL_DBCT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGCTL_ASVLD_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGCTL_BSVLD_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_GOTGCTL_Register is record
      ...
      --  unspecified
      Reserved_2_7   : Interfaces.ST.UInt6 := 16#0#;
      ...
      --  unspecified
      Reserved_12_15 : Interfaces.ST.UInt4 := 16#0#;
      ...
      --  unspecified
      Reserved_20_31 : Interfaces.ST.UInt12 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_GOTGINT_SEDET_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGINT_SRSSCHG_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGINT_HNSSCHG_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGINT_HNGDET_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGINT_ADTOCHG_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GOTGINT_DBCDNE_Field is Interfaces.ST.Bit;
   ...
   subtype OTG_HS_GAHBCFG_GINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GAHBCFG_HBSTLEN_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_GAHBCFG_DMAEN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GAHBCFG_TXFELVL_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GAHBCFG_PTXFELVL_Field is Interfaces.ST.Bit;
   ...
   subtype OTG_HS_GUSBCFG_TOCAL_Field is Interfaces.ST.UInt3;
   subtype OTG_HS_GUSBCFG_PHYSEL_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_SRPCAP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_HNPCAP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_TRDT_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_GUSBCFG_PHYLPCS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_ULPIFSLS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_ULPIAR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_ULPICSM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_ULPIEVBUSD_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_ULPIEVBUSI_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_TSDPS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_PCCI_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_PTCI_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_ULPIIPD_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_FHMOD_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_FDMOD_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GUSBCFG_CTXPKT_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_GUSBCFG_Register is record
      ...
      --  unspecified
      Reserved_3_5   : Interfaces.ST.UInt3 := 16#0#;
      ...
      --  unspecified
      Reserved_14_14 : Interfaces.ST.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_26_28 : Interfaces.ST.UInt3 := 16#0#;
      --  Forced host mode
   ...
   subtype OTG_HS_GRSTCTL_CSRST_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GRSTCTL_HSRST_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GRSTCTL_FCRST_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GRSTCTL_RXFFLSH_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GRSTCTL_TXFFLSH_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GRSTCTL_TXFNUM_Field is Interfaces.ST.UInt5;
   subtype OTG_HS_GRSTCTL_DMAREQ_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GRSTCTL_AHBIDL_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_GRSTCTL_Register is record
      ...
      --  unspecified
      Reserved_11_29 : Interfaces.ST.UInt19 := 16#40000#;
   ...
   subtype OTG_HS_GINTSTS_CMOD_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_MMIS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_OTGINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_SOF_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_RXFLVL_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_NPTXFE_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_GINAKEFF_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_BOUTNAKEFF_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_ESUSP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_USBSUSP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_USBRST_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_ENUMDNE_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_ISOODRP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_EOPF_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_IEPINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_OEPINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_IISOIXFR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_PXFR_INCOMPISOOUT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_DATAFSUSP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_HPRTINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_HCINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_PTXFE_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_CIDSCHG_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_DISCINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_SRQINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTSTS_WKUINT_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_GINTSTS_Register is record
      ...
      --  unspecified
      Reserved_8_9      : Interfaces.ST.UInt2 := 16#0#;
      --  Early suspend
      ...
      --  unspecified
      Reserved_16_17    : Interfaces.ST.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_23_23    : Interfaces.ST.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_27_27    : Interfaces.ST.Bit := 16#0#;
   ...
   subtype OTG_HS_GINTMSK_MMISM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_OTGINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_SOFM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_RXFLVLM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_NPTXFEM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_GINAKEFFM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_GONAKEFFM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_ESUSPM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_USBSUSPM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_USBRST_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_ENUMDNEM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_ISOODRPM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_EOPFM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_EPMISM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_IEPINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_OEPINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_IISOIXFRM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_PXFRM_IISOOXFRM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_FSUSPM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_PRTIM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_HCIM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_PTXFEM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_CIDSCHGM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_DISCINT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_SRQIM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GINTMSK_WUIM_Field is Interfaces.ST.Bit;
   ...
   subtype OTG_HS_GRXSTSR_Host_CHNUM_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_GRXSTSR_Host_BCNT_Field is Interfaces.ST.UInt11;
   subtype OTG_HS_GRXSTSR_Host_DPID_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_GRXSTSR_Host_PKTSTS_Field is Interfaces.ST.UInt4;
   ...
   type OTG_HS_GRXSTSR_Host_Register is record
      ...
      --  unspecified
      Reserved_21_31 : Interfaces.ST.UInt11;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_GRXSTSR_Peripheral_EPNUM_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_GRXSTSR_Peripheral_BCNT_Field is Interfaces.ST.UInt11;
   subtype OTG_HS_GRXSTSR_Peripheral_DPID_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_GRXSTSR_Peripheral_PKTSTS_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_GRXSTSR_Peripheral_FRMNUM_Field is Interfaces.ST.UInt4;
   ...
   subtype OTG_HS_GRXSTSP_Host_CHNUM_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_GRXSTSP_Host_BCNT_Field is Interfaces.ST.UInt11;
   subtype OTG_HS_GRXSTSP_Host_DPID_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_GRXSTSP_Host_PKTSTS_Field is Interfaces.ST.UInt4;
   ...
   subtype OTG_HS_GRXSTSP_Peripheral_EPNUM_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_GRXSTSP_Peripheral_BCNT_Field is Interfaces.ST.UInt11;
   subtype OTG_HS_GRXSTSP_Peripheral_DPID_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_GRXSTSP_Peripheral_PKTSTS_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_GRXSTSP_Peripheral_FRMNUM_Field is Interfaces.ST.UInt4;
   ...
   subtype OTG_HS_GRXFSIZ_RXFD_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_GNPTXFSIZ_Host_NPTXFSA_Field is Interfaces.ST.UInt16;
   subtype OTG_HS_GNPTXFSIZ_Host_NPTXFD_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_TX0FSIZ_Peripheral_TX0FSA_Field is Interfaces.ST.UInt16;
   subtype OTG_HS_TX0FSIZ_Peripheral_TX0FD_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_GNPTXSTS_NPTXFSAV_Field is Interfaces.ST.UInt16;
   subtype OTG_HS_GNPTXSTS_NPTQXSAV_Field is Interfaces.ST.Byte;
   subtype OTG_HS_GNPTXSTS_NPTXQTOP_Field is Interfaces.ST.UInt7;
   ...
   type OTG_HS_GNPTXSTS_Register is record
      ...
      --  unspecified
      Reserved_31_31 : Interfaces.ST.Bit;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_GCCFG_PWRDWN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GCCFG_I2CPADEN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GCCFG_VBUSASEN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GCCFG_VBUSBSEN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GCCFG_SOFOUTEN_Field is Interfaces.ST.Bit;
   subtype OTG_HS_GCCFG_NOVBUSSENS_Field is Interfaces.ST.Bit;

   --  OTG_HS general core configuration register
   type OTG_HS_GCCFG_Register is record
      --  unspecified
      Reserved_0_15  : Interfaces.ST.UInt16 := 16#0#;
      --  Power down
      ...
      --  unspecified
      Reserved_22_31 : Interfaces.ST.UInt10 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_HPTXFSIZ_PTXSA_Field is Interfaces.ST.UInt16;
   subtype OTG_HS_HPTXFSIZ_PTXFD_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_DIEPTXF_INEPTXSA_Field is Interfaces.ST.UInt16;
   subtype OTG_HS_DIEPTXF_INEPTXFD_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_HCFG_FSLSPCS_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_HCFG_FSLSS_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_HCFG_Register is record
      ...
      --  unspecified
      Reserved_3_31 : Interfaces.ST.UInt29 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_HFIR_FRIVL_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_HFNUM_FRNUM_Field is Interfaces.ST.UInt16;
   subtype OTG_HS_HFNUM_FTREM_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_HPTXSTS_PTXFSAVL_Field is Interfaces.ST.UInt16;
   subtype OTG_HS_HPTXSTS_PTXQSAV_Field is Interfaces.ST.Byte;
   subtype OTG_HS_HPTXSTS_PTXQTOP_Field is Interfaces.ST.Byte;
   ...
   subtype OTG_HS_HAINT_HAINT_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_HAINTMSK_HAINTM_Field is Interfaces.ST.UInt16;
   ...
   subtype OTG_HS_HPRT_PCSTS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HPRT_PCDET_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HPRT_PENA_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HPRT_PENCHNG_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HPRT_POCA_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HPRT_POCCHNG_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HPRT_PRES_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HPRT_PSUSP_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HPRT_PRST_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HPRT_PLSTS_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_HPRT_PPWR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HPRT_PTCTL_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_HPRT_PSPD_Field is Interfaces.ST.UInt2;
   ...
   type OTG_HS_HPRT_Register is record
      ...
      --  unspecified
      Reserved_9_9   : Interfaces.ST.Bit := 16#0#;
   ...
   subtype OTG_HS_HCCHAR_MPSIZ_Field is Interfaces.ST.UInt11;
   subtype OTG_HS_HCCHAR_EPNUM_Field is Interfaces.ST.UInt4;
   subtype OTG_HS_HCCHAR_EPDIR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCCHAR_LSDEV_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCCHAR_EPTYP_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_HCCHAR_MC_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_HCCHAR_DAD_Field is Interfaces.ST.UInt7;
   subtype OTG_HS_HCCHAR_ODDFRM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCCHAR_CHDIS_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCCHAR_CHENA_Field is Interfaces.ST.Bit;
   ...
   subtype OTG_HS_HCSPLT_PRTADDR_Field is Interfaces.ST.UInt7;
   subtype OTG_HS_HCSPLT_HUBADDR_Field is Interfaces.ST.UInt7;
   subtype OTG_HS_HCSPLT_XACTPOS_Field is Interfaces.ST.UInt2;
   subtype OTG_HS_HCSPLT_COMPLSPLT_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCSPLT_SPLITEN_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_HCSPLT_Register is record
      ...
      --  unspecified
      Reserved_17_30 : Interfaces.ST.UInt14 := 16#0#;
      --  Split enable
   ...
   subtype OTG_HS_HCINT_XFRC_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINT_CHH_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINT_AHBERR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINT_STALL_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINT_NAK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINT_ACK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINT_NYET_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINT_TXERR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINT_BBERR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINT_FRMOR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINT_DTERR_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_HCINT_Register is record
      ...
      --  unspecified
      Reserved_11_31 : Interfaces.ST.UInt21 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_HCINTMSK_XFRCM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINTMSK_CHHM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINTMSK_AHBERR_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINTMSK_STALLM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINTMSK_NAKM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINTMSK_ACKM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINTMSK_NYET_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINTMSK_TXERRM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINTMSK_BBERRM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINTMSK_FRMORM_Field is Interfaces.ST.Bit;
   subtype OTG_HS_HCINTMSK_DTERRM_Field is Interfaces.ST.Bit;
   ...
   subtype OTG_HS_HCTSIZ_XFRSIZ_Field is Interfaces.ST.UInt19;
   subtype OTG_HS_HCTSIZ_PKTCNT_Field is Interfaces.ST.UInt10;
   subtype OTG_HS_HCTSIZ_DPID_Field is Interfaces.ST.UInt2;
   ...
   subtype OTG_HS_PCGCR_STPPCLK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_PCGCR_GATEHCLK_Field is Interfaces.ST.Bit;
   subtype OTG_HS_PCGCR_PHYSUSP_Field is Interfaces.ST.Bit;
   ...
   type OTG_HS_PCGCR_Register is record
      ...
      --  unspecified
      Reserved_2_3  : Interfaces.ST.UInt2 := 16#0#;
      --  PHY suspended
      PHYSUSP       : OTG_HS_PCGCR_PHYSUSP_Field := 16#0#;
      --  unspecified
      Reserved_5_31 : Interfaces.ST.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type OTG_HS_DEVICE_Peripheral is record
      ...
      OTG_HS_DIEPDMA1     : aliased Interfaces.ST.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA2     : aliased Interfaces.ST.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA3     : aliased Interfaces.ST.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA4     : aliased Interfaces.ST.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA5     : aliased Interfaces.ST.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
   ...
   is record
      ...
      OTG_HS_CID                : aliased Interfaces.ST.UInt32;
      --  OTG_HS Host periodic transmit FIFO size register
   ...
   type OTG_HS_HOST_Peripheral is record
      ...
      OTG_HS_HCDMA0     : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA1     : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA2     : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA3     : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA4     : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA5     : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA6     : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA7     : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA8     : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA9     : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA10    : aliased Interfaces.ST.UInt32;
      ...
      OTG_HS_HCDMA11    : aliased Interfaces.ST.UInt32;
   end record
     with Volatile;
