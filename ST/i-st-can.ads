...
package Interfaces.ST.CAN is
   ...
   subtype MCR_INRQ_Field is Interfaces.ST.Bit;
   subtype MCR_SLEEP_Field is Interfaces.ST.Bit;
   subtype MCR_TXFP_Field is Interfaces.ST.Bit;
   subtype MCR_RFLM_Field is Interfaces.ST.Bit;
   subtype MCR_NART_Field is Interfaces.ST.Bit;
   subtype MCR_AWUM_Field is Interfaces.ST.Bit;
   subtype MCR_ABOM_Field is Interfaces.ST.Bit;
   subtype MCR_TTCM_Field is Interfaces.ST.Bit;
   subtype MCR_RESET_Field is Interfaces.ST.Bit;
   subtype MCR_DBF_Field is Interfaces.ST.Bit;
   ...
   type MCR_Register is record
      ...
      --  unspecified
      Reserved_8_14  : Interfaces.ST.UInt7 := 16#0#;
      --  RESET
   ...
   subtype MSR_INAK_Field is Interfaces.ST.Bit;
   subtype MSR_SLAK_Field is Interfaces.ST.Bit;
   subtype MSR_ERRI_Field is Interfaces.ST.Bit;
   subtype MSR_WKUI_Field is Interfaces.ST.Bit;
   subtype MSR_SLAKI_Field is Interfaces.ST.Bit;
   subtype MSR_TXM_Field is Interfaces.ST.Bit;
   subtype MSR_RXM_Field is Interfaces.ST.Bit;
   subtype MSR_SAMP_Field is Interfaces.ST.Bit;
   subtype MSR_RX_Field is Interfaces.ST.Bit;
   ...
   subtype TSR_RQCP0_Field is Interfaces.ST.Bit;
   subtype TSR_TXOK0_Field is Interfaces.ST.Bit;
   subtype TSR_ALST0_Field is Interfaces.ST.Bit;
   subtype TSR_TERR0_Field is Interfaces.ST.Bit;
   subtype TSR_ABRQ0_Field is Interfaces.ST.Bit;
   subtype TSR_RQCP1_Field is Interfaces.ST.Bit;
   subtype TSR_TXOK1_Field is Interfaces.ST.Bit;
   subtype TSR_ALST1_Field is Interfaces.ST.Bit;
   subtype TSR_TERR1_Field is Interfaces.ST.Bit;
   subtype TSR_ABRQ1_Field is Interfaces.ST.Bit;
   subtype TSR_RQCP2_Field is Interfaces.ST.Bit;
   subtype TSR_TXOK2_Field is Interfaces.ST.Bit;
   subtype TSR_ALST2_Field is Interfaces.ST.Bit;
   subtype TSR_TERR2_Field is Interfaces.ST.Bit;
   subtype TSR_ABRQ2_Field is Interfaces.ST.Bit;
   subtype TSR_CODE_Field is Interfaces.ST.UInt2;
   --  TSR_TME array element
   subtype TSR_TME_Element is Interfaces.ST.Bit;
   ...
   subtype TSR_LOW_Element is Interfaces.ST.Bit;
   ...
   type TSR_Register is record
      ...
      --  unspecified
      Reserved_12_14 : Interfaces.ST.UInt3 := 16#0#;
      --  ABRQ1
      ...
      --  unspecified
      Reserved_20_22 : Interfaces.ST.UInt3 := 16#0#;
      --  ABRQ2
   ...
   subtype RF0R_FMP0_Field is Interfaces.ST.UInt2;
   subtype RF0R_FULL0_Field is Interfaces.ST.Bit;
   subtype RF0R_FOVR0_Field is Interfaces.ST.Bit;
   subtype RF0R_RFOM0_Field is Interfaces.ST.Bit;
   ...
   subtype RF1R_FMP1_Field is Interfaces.ST.UInt2;
   subtype RF1R_FULL1_Field is Interfaces.ST.Bit;
   subtype RF1R_FOVR1_Field is Interfaces.ST.Bit;
   subtype RF1R_RFOM1_Field is Interfaces.ST.Bit;
   ...
   subtype IER_TMEIE_Field is Interfaces.ST.Bit;
   subtype IER_FMPIE0_Field is Interfaces.ST.Bit;
   subtype IER_FFIE0_Field is Interfaces.ST.Bit;
   subtype IER_FOVIE0_Field is Interfaces.ST.Bit;
   subtype IER_FMPIE1_Field is Interfaces.ST.Bit;
   subtype IER_FFIE1_Field is Interfaces.ST.Bit;
   subtype IER_FOVIE1_Field is Interfaces.ST.Bit;
   subtype IER_EWGIE_Field is Interfaces.ST.Bit;
   subtype IER_EPVIE_Field is Interfaces.ST.Bit;
   subtype IER_BOFIE_Field is Interfaces.ST.Bit;
   subtype IER_LECIE_Field is Interfaces.ST.Bit;
   subtype IER_ERRIE_Field is Interfaces.ST.Bit;
   subtype IER_WKUIE_Field is Interfaces.ST.Bit;
   subtype IER_SLKIE_Field is Interfaces.ST.Bit;
   ...
   subtype ESR_EWGF_Field is Interfaces.ST.Bit;
   subtype ESR_EPVF_Field is Interfaces.ST.Bit;
   subtype ESR_BOFF_Field is Interfaces.ST.Bit;
   subtype ESR_LEC_Field is Interfaces.ST.UInt3;
   subtype ESR_TEC_Field is Interfaces.ST.Byte;
   subtype ESR_REC_Field is Interfaces.ST.Byte;
   ...
   type ESR_Register is record
      ...
      --  unspecified
      Reserved_7_15 : Interfaces.ST.UInt9 := 16#0#;
      --  Read-only. TEC
   ...
   subtype BTR_BRP_Field is Interfaces.ST.UInt10;
   subtype BTR_TS1_Field is Interfaces.ST.UInt4;
   subtype BTR_TS2_Field is Interfaces.ST.UInt3;
   subtype BTR_SJW_Field is Interfaces.ST.UInt2;
   subtype BTR_LBKM_Field is Interfaces.ST.Bit;
   subtype BTR_SILM_Field is Interfaces.ST.Bit;
   ...
   type BTR_Register is record
      ...
      --  unspecified
      Reserved_10_15 : Interfaces.ST.UInt6 := 16#0#;
      --  TS1
      ...
      --  unspecified
      Reserved_26_29 : Interfaces.ST.UInt4 := 16#0#;
      --  LBKM
   ...
   subtype TI0R_TXRQ_Field is Interfaces.ST.Bit;
   subtype TI0R_RTR_Field is Interfaces.ST.Bit;
   subtype TI0R_IDE_Field is Interfaces.ST.Bit;
   subtype TI0R_EXID_Field is Interfaces.ST.UInt18;
   subtype TI0R_STID_Field is Interfaces.ST.UInt11;
   ...
   subtype TDT0R_DLC_Field is Interfaces.ST.UInt4;
   subtype TDT0R_TGT_Field is Interfaces.ST.Bit;
   subtype TDT0R_TIME_Field is Interfaces.ST.UInt16;
   ...
   type TDT0R_Register is record
      ...
      --  unspecified
      Reserved_4_7  : Interfaces.ST.UInt4 := 16#0#;
      --  TGT
      TGT           : TDT0R_TGT_Field := 16#0#;
      --  unspecified
      Reserved_9_15 : Interfaces.ST.UInt7 := 16#0#;
      --  TIME
   ...
   subtype TDL0R_DATA_Element is Interfaces.ST.Byte;
   ...
   subtype TDH0R_DATA_Element is Interfaces.ST.Byte;
   ...
   subtype TI1R_TXRQ_Field is Interfaces.ST.Bit;
   subtype TI1R_RTR_Field is Interfaces.ST.Bit;
   subtype TI1R_IDE_Field is Interfaces.ST.Bit;
   subtype TI1R_EXID_Field is Interfaces.ST.UInt18;
   subtype TI1R_STID_Field is Interfaces.ST.UInt11;
   ...
   subtype TDT1R_DLC_Field is Interfaces.ST.UInt4;
   subtype TDT1R_TGT_Field is Interfaces.ST.Bit;
   subtype TDT1R_TIME_Field is Interfaces.ST.UInt16;
   ...
   subtype TDL1R_DATA_Element is Interfaces.ST.Byte;
   ...
   subtype TDH1R_DATA_Element is Interfaces.ST.Byte;
   ...
   subtype TI2R_TXRQ_Field is Interfaces.ST.Bit;
   subtype TI2R_RTR_Field is Interfaces.ST.Bit;
   subtype TI2R_IDE_Field is Interfaces.ST.Bit;
   subtype TI2R_EXID_Field is Interfaces.ST.UInt18;
   subtype TI2R_STID_Field is Interfaces.ST.UInt11;
   ...
   subtype TDT2R_DLC_Field is Interfaces.ST.UInt4;
   subtype TDT2R_TGT_Field is Interfaces.ST.Bit;
   subtype TDT2R_TIME_Field is Interfaces.ST.UInt16;
   ...
   subtype TDL2R_DATA_Element is Interfaces.ST.Byte;
   ...
   subtype TDH2R_DATA_Element is Interfaces.ST.Byte;
   ...
   subtype RI0R_RTR_Field is Interfaces.ST.Bit;
   subtype RI0R_IDE_Field is Interfaces.ST.Bit;
   subtype RI0R_EXID_Field is Interfaces.ST.UInt18;
   subtype RI0R_STID_Field is Interfaces.ST.UInt11;

   --  receive FIFO mailbox identifier register
   type RI0R_Register is record
      --  unspecified
      Reserved_0_0 : Interfaces.ST.Bit;
      --  Read-only. RTR
      RTR          : RI0R_RTR_Field;
      --  Read-only. IDE
      IDE          : RI0R_IDE_Field;
   ...
   subtype RDT0R_DLC_Field is Interfaces.ST.UInt4;
   subtype RDT0R_FMI_Field is Interfaces.ST.Byte;
   subtype RDT0R_TIME_Field is Interfaces.ST.UInt16;
   ...
   subtype RDL0R_DATA_Element is Interfaces.ST.Byte;
   ...
   subtype RDH0R_DATA_Element is Interfaces.ST.Byte;
   ...
   subtype RI1R_RTR_Field is Interfaces.ST.Bit;
   subtype RI1R_IDE_Field is Interfaces.ST.Bit;
   subtype RI1R_EXID_Field is Interfaces.ST.UInt18;
   subtype RI1R_STID_Field is Interfaces.ST.UInt11;
   ...
   subtype RDT1R_DLC_Field is Interfaces.ST.UInt4;
   subtype RDT1R_FMI_Field is Interfaces.ST.Byte;
   subtype RDT1R_TIME_Field is Interfaces.ST.UInt16;
   ...
   subtype RDL1R_DATA_Element is Interfaces.ST.Byte;
   ...
   subtype RDH1R_DATA_Element is Interfaces.ST.Byte;
   ...
   subtype FMR_FINIT_Field is Interfaces.ST.Bit;
   subtype FMR_CAN2SB_Field is Interfaces.ST.UInt6;
   ...
   type FMR_Register is record
      ...
      --  unspecified
      Reserved_14_31 : Interfaces.ST.UInt18 := 16#A870#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FM1R_FBM_Element is Interfaces.ST.Bit;
   ...
   subtype FS1R_FSC_Element is Interfaces.ST.Bit;
   ...
   subtype FFA1R_FFA_Element is Interfaces.ST.Bit;
   ...
   subtype FA1R_FACT_Element is Interfaces.ST.Bit;
   ...
   subtype F0R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F1R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F2R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F3R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F4R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F5R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F6R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F7R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F8R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F9R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F10R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F11R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F12R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F13R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F14R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F15R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F16R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F17R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F18R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F19R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F20R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F21R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F22R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F23R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F24R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F25R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F26R_FB_Element is Interfaces.ST.Bit;
   ...
   subtype F27R_FB_Element is Interfaces.ST.Bit;
