...
package Interfaces.ST.SYSCFG is
   pragma Preelaborate;
   ...
   subtype MEMRM_MEM_MODE_Field is Interfaces.ST.UInt2;
   ...
   subtype PMC_MII_RMII_SEL_Field is Interfaces.ST.Bit;

   --  peripheral mode configuration register
   type PMC_Register is record
      --  unspecified
      Reserved_0_22  : Interfaces.ST.UInt23 := 16#0#;
   ...
   subtype EXTICR1_EXTI_Element is Interfaces.ST.UInt4;
   ...
   subtype EXTICR2_EXTI_Element is Interfaces.ST.UInt4;
   ...
   subtype EXTICR3_EXTI_Element is Interfaces.ST.UInt4;
   ...
   subtype EXTICR4_EXTI_Element is Interfaces.ST.UInt4;
   ...
   subtype CMPCR_CMP_PD_Field is Interfaces.ST.Bit;
   subtype CMPCR_READY_Field is Interfaces.ST.Bit;
   ...
   type CMPCR_Register is record
      ...
      --  unspecified
      Reserved_1_7  : Interfaces.ST.UInt7;
      --  Read-only. READY
      READY         : CMPCR_READY_Field;
      --  unspecified
      Reserved_9_31 : Interfaces.ST.UInt23;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
