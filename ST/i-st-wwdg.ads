...
package Interfaces.ST.WWDG is
   ...
   subtype CR_T_Field is Interfaces.ST.UInt7;
   subtype CR_WDGA_Field is Interfaces.ST.Bit;
   ...
   subtype CFR_W_Field is Interfaces.ST.UInt7;
   --  CFR_WDGTB array element
   subtype CFR_WDGTB_Element is Interfaces.ST.Bit;
   ...
   subtype CFR_EWI_Field is Interfaces.ST.Bit;
   ...
   subtype SR_EWIF_Field is Interfaces.ST.Bit;
