...
package Interfaces.ST.I2C is
   ...
   subtype CR1_PE_Field is Interfaces.ST.Bit;
   subtype CR1_SMBUS_Field is Interfaces.ST.Bit;
   subtype CR1_SMBTYPE_Field is Interfaces.ST.Bit;
   subtype CR1_ENARP_Field is Interfaces.ST.Bit;
   subtype CR1_ENPEC_Field is Interfaces.ST.Bit;
   subtype CR1_ENGC_Field is Interfaces.ST.Bit;
   subtype CR1_NOSTRETCH_Field is Interfaces.ST.Bit;
   subtype CR1_START_Field is Interfaces.ST.Bit;
   subtype CR1_STOP_Field is Interfaces.ST.Bit;
   subtype CR1_ACK_Field is Interfaces.ST.Bit;
   subtype CR1_POS_Field is Interfaces.ST.Bit;
   subtype CR1_PEC_Field is Interfaces.ST.Bit;
   subtype CR1_ALERT_Field is Interfaces.ST.Bit;
   subtype CR1_SWRST_Field is Interfaces.ST.Bit;
   ...
   subtype CR2_FREQ_Field is Interfaces.ST.UInt6;
   subtype CR2_ITERREN_Field is Interfaces.ST.Bit;
   subtype CR2_ITEVTEN_Field is Interfaces.ST.Bit;
   subtype CR2_ITBUFEN_Field is Interfaces.ST.Bit;
   subtype CR2_DMAEN_Field is Interfaces.ST.Bit;
   subtype CR2_LAST_Field is Interfaces.ST.Bit;
   ...
   subtype OAR1_ADD0_Field is Interfaces.ST.Bit;
   subtype OAR1_ADD7_Field is Interfaces.ST.UInt7;
   subtype OAR1_ADD10_Field is Interfaces.ST.UInt2;
   subtype OAR1_ADDMODE_Field is Interfaces.ST.Bit;
   ...
   subtype OAR2_ENDUAL_Field is Interfaces.ST.Bit;
   subtype OAR2_ADD2_Field is Interfaces.ST.UInt7;
   ...
   subtype DR_DR_Field is Interfaces.ST.Byte;
   ...
   subtype SR1_SB_Field is Interfaces.ST.Bit;
   subtype SR1_ADDR_Field is Interfaces.ST.Bit;
   subtype SR1_BTF_Field is Interfaces.ST.Bit;
   subtype SR1_ADD10_Field is Interfaces.ST.Bit;
   subtype SR1_STOPF_Field is Interfaces.ST.Bit;
   subtype SR1_RxNE_Field is Interfaces.ST.Bit;
   subtype SR1_TxE_Field is Interfaces.ST.Bit;
   subtype SR1_BERR_Field is Interfaces.ST.Bit;
   subtype SR1_ARLO_Field is Interfaces.ST.Bit;
   subtype SR1_AF_Field is Interfaces.ST.Bit;
   subtype SR1_OVR_Field is Interfaces.ST.Bit;
   subtype SR1_PECERR_Field is Interfaces.ST.Bit;
   subtype SR1_TIMEOUT_Field is Interfaces.ST.Bit;
   subtype SR1_SMBALERT_Field is Interfaces.ST.Bit;
   ...
   subtype SR2_MSL_Field is Interfaces.ST.Bit;
   subtype SR2_BUSY_Field is Interfaces.ST.Bit;
   subtype SR2_TRA_Field is Interfaces.ST.Bit;
   subtype SR2_GENCALL_Field is Interfaces.ST.Bit;
   subtype SR2_SMBDEFAULT_Field is Interfaces.ST.Bit;
   subtype SR2_SMBHOST_Field is Interfaces.ST.Bit;
   subtype SR2_DUALF_Field is Interfaces.ST.Bit;
   subtype SR2_PEC_Field is Interfaces.ST.Byte;
   ...
   type SR2_Register is record
      ...
      TRA            : SR2_TRA_Field;
      --  unspecified
      Reserved_3_3   : Interfaces.ST.Bit;
   ...
   subtype CCR_CCR_Field is Interfaces.ST.UInt12;
   subtype CCR_DUTY_Field is Interfaces.ST.Bit;
   subtype CCR_F_S_Field is Interfaces.ST.Bit;
   ...
   subtype TRISE_TRISE_Field is Interfaces.ST.UInt6;
