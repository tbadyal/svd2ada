...
package Interfaces.STM32.RTC is
   ...
   subtype TSTR_TAMP1E_Field is Interfaces.STM32.Bit;
   subtype TSTR_TAMP1TRG_Field is Interfaces.STM32.Bit;
   subtype TSTR_TAMPIE_Field is Interfaces.STM32.Bit;
   subtype TSTR_TAMP1INSEL_Field is Interfaces.STM32.Bit;
   subtype TSTR_TSINSEL_Field is Interfaces.STM32.Bit;
   subtype TSTR_ALARMOUTTYPE_Field is Interfaces.STM32.Bit;
   ...
   type TSTR_Register is record
      ...
      --  unspecified
      Reserved_3_15  : Interfaces.STM32.UInt13;
