...
package Interfaces.SAM.EFC is
   ...
   subtype EFC0_FMR_CLOE_Field is Interfaces.SAM.Bit;
...
--  no action is started.
   ...
   subtype EFC0_FSR_FLERR_Field is Interfaces.SAM.Bit;
