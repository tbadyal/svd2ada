...
package Interfaces.SAM.UDP is
   ...
   subtype UDP_IER_EP6INT_Field is Interfaces.SAM.Bit;
   subtype UDP_IER_EP7INT_Field is Interfaces.SAM.Bit;
   ...
   type UDP_IER_Register is record
      ...
      EP6INT         : UDP_IER_EP6INT_Field := 16#0#;
      --  Write-only. Enable Endpoint 7 Interrupt
      EP7INT         : UDP_IER_EP7INT_Field := 16#0#;
   ...
   subtype UDP_IDR_EP6INT_Field is Interfaces.SAM.Bit;
   subtype UDP_IDR_EP7INT_Field is Interfaces.SAM.Bit;
   ...
   type UDP_IDR_Register is record
      ...
      EP6INT         : UDP_IDR_EP6INT_Field := 16#0#;
      --  Write-only. Disable Endpoint 7 Interrupt
      EP7INT         : UDP_IDR_EP7INT_Field := 16#0#;
   ...
   subtype UDP_IMR_EP6INT_Field is Interfaces.SAM.Bit;
   subtype UDP_IMR_EP7INT_Field is Interfaces.SAM.Bit;
   ...
   type UDP_IMR_Register is record
      ...
      EP6INT         : UDP_IMR_EP6INT_Field;
      --  Read-only. Mask Endpoint 7 Interrupt
      EP7INT         : UDP_IMR_EP7INT_Field;
   ...
   subtype UDP_ISR_EP6INT_Field is Interfaces.SAM.Bit;
   subtype UDP_ISR_EP7INT_Field is Interfaces.SAM.Bit;
   ...
   type UDP_ISR_Register is record
      ...
      EP6INT         : UDP_ISR_EP6INT_Field;
      --  Read-only. Endpoint 7Interrupt Status
      EP7INT         : UDP_ISR_EP7INT_Field;
   ...
   --  UDP_RST_EP_EP array
   type UDP_RST_EP_EP_Field_Array is array (0 .. 7) of UDP_RST_EP_EP_Element
   ...
   subtype UDP_CSR_TXCOMP_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR_RX_DATA_BK0_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR_RXSETUP_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR_STALLSENT_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR_TXPKTRDY_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR_FORCESTALL_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR_RX_DATA_BK1_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR_DIR_Field is Interfaces.SAM.Bit;
   ...
   subtype UDP_CSR_DTGLE_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR_EPEDS_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR_RXBYTECNT_Field is Interfaces.SAM.UInt11;
   ...
   type UDP_CSR_Register is record
      ...
      TXCOMP         : UDP_CSR_TXCOMP_Field := 16#0#;
      --  Receive Data Bank 0
      RX_DATA_BK0    : UDP_CSR_RX_DATA_BK0_Field := 16#0#;
      --  Received Setup
      RXSETUP        : UDP_CSR_RXSETUP_Field := 16#0#;
      --  Stall Sent
      STALLSENT      : UDP_CSR_STALLSENT_Field := 16#0#;
      --  Transmit Packet Ready
      TXPKTRDY       : UDP_CSR_TXPKTRDY_Field := 16#0#;
      --  Force Stall (used by Control, Bulk and Isochronous Endpoints)
      FORCESTALL     : UDP_CSR_FORCESTALL_Field := 16#0#;
      --  Receive Data Bank 1 (only used by endpoints with ping-pong
      --  attributes)
      RX_DATA_BK1    : UDP_CSR_RX_DATA_BK1_Field := 16#0#;
      --  Transfer Direction (only available for control endpoints)
      DIR            : UDP_CSR_DIR_Field := 16#0#;
      --  Endpoint Type
      EPTYPE         : CSR_EPTYPE_Field := Interfaces.SAM.UDP.CTRL;
      --  Data Toggle
      DTGLE          : UDP_CSR_DTGLE_Field := 16#0#;
      --  unspecified
      Reserved_12_14 : Interfaces.SAM.UInt3 := 16#0#;
      --  Endpoint Enable Disable
      EPEDS          : UDP_CSR_EPEDS_Field := 16#0#;
   ...
   subtype UDP_CSR0_ISOENDPT_TXCOMP_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR0_ISOENDPT_RX_DATA_BK0_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR0_ISOENDPT_RXSETUP_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR0_ISOENDPT_ISOERROR_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR0_ISOENDPT_TXPKTRDY_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR0_ISOENDPT_FORCESTALL_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR0_ISOENDPT_RX_DATA_BK1_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR0_ISOENDPT_DIR_Field is Interfaces.SAM.Bit;
   ...
   subtype UDP_CSR0_ISOENDPT_DTGLE_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR0_ISOENDPT_EPEDS_Field is Interfaces.SAM.Bit;
   subtype UDP_CSR0_ISOENDPT_RXBYTECNT_Field is Interfaces.SAM.UInt11;

   --  Endpoint Control and Status Register
   type UDP_CSR0_ISOENDPT_Register is record
      --  Generates an IN Packet with Data Previously Written in the DPR
      TXCOMP         : UDP_CSR0_ISOENDPT_TXCOMP_Field := 16#0#;
      --  Receive Data Bank 0
      RX_DATA_BK0    : UDP_CSR0_ISOENDPT_RX_DATA_BK0_Field := 16#0#;
      --  Received Setup
      RXSETUP        : UDP_CSR0_ISOENDPT_RXSETUP_Field := 16#0#;
      --  A CRC error has been detected in an isochronous transfer
      ISOERROR       : UDP_CSR0_ISOENDPT_ISOERROR_Field := 16#0#;
      --  Transmit Packet Ready
      TXPKTRDY       : UDP_CSR0_ISOENDPT_TXPKTRDY_Field := 16#0#;
      --  Force Stall (used by Control, Bulk and Isochronous Endpoints)
      FORCESTALL     : UDP_CSR0_ISOENDPT_FORCESTALL_Field := 16#0#;
      --  Receive Data Bank 1 (only used by endpoints with ping-pong
      --  attributes)
      RX_DATA_BK1    : UDP_CSR0_ISOENDPT_RX_DATA_BK1_Field := 16#0#;
      --  Transfer Direction (only available for control endpoints)
      DIR            : UDP_CSR0_ISOENDPT_DIR_Field := 16#0#;
      --  Endpoint Type
      EPTYPE         : CSR0_ISOENDPT_EPTYPE_Field := Interfaces.SAM.UDP.CTRL;
      --  Data Toggle
      DTGLE          : UDP_CSR0_ISOENDPT_DTGLE_Field := 16#0#;
      --  unspecified
      Reserved_12_14 : Interfaces.SAM.UInt3 := 16#0#;
      --  Endpoint Enable Disable
      EPEDS          : UDP_CSR0_ISOENDPT_EPEDS_Field := 16#0#;
      --  Number of Bytes Available in the FIFO
