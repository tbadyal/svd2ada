...
package Interfaces.SAM.TC is
   ...
   subtype TC0_BMR_QDEN_Field is Interfaces.SAM.Bit;
   subtype TC0_BMR_POSEN_Field is Interfaces.SAM.Bit;
   subtype TC0_BMR_SPEEDEN_Field is Interfaces.SAM.Bit;
   subtype TC0_BMR_QDTRANS_Field is Interfaces.SAM.Bit;
   subtype TC0_BMR_EDGPHA_Field is Interfaces.SAM.Bit;
   subtype TC0_BMR_INVA_Field is Interfaces.SAM.Bit;
   subtype TC0_BMR_INVB_Field is Interfaces.SAM.Bit;
   subtype TC0_BMR_INVIDX_Field is Interfaces.SAM.Bit;
   subtype TC0_BMR_SWAP_Field is Interfaces.SAM.Bit;
   subtype TC0_BMR_IDXPHB_Field is Interfaces.SAM.Bit;
   subtype TC0_BMR_FILTER_Field is Interfaces.SAM.Bit;
   ...
   subtype TC0_QIER_IDX_Field is Interfaces.SAM.Bit;
   subtype TC0_QIER_DIRCHG_Field is Interfaces.SAM.Bit;
   subtype TC0_QIER_QERR_Field is Interfaces.SAM.Bit;
   ...
   subtype TC0_QIDR_IDX_Field is Interfaces.SAM.Bit;
   subtype TC0_QIDR_DIRCHG_Field is Interfaces.SAM.Bit;
   subtype TC0_QIDR_QERR_Field is Interfaces.SAM.Bit;
   ...
   subtype TC0_QIMR_IDX_Field is Interfaces.SAM.Bit;
   subtype TC0_QIMR_DIRCHG_Field is Interfaces.SAM.Bit;
   subtype TC0_QIMR_QERR_Field is Interfaces.SAM.Bit;
   ...
   subtype TC0_QISR_IDX_Field is Interfaces.SAM.Bit;
   subtype TC0_QISR_DIRCHG_Field is Interfaces.SAM.Bit;
   subtype TC0_QISR_QERR_Field is Interfaces.SAM.Bit;
   subtype TC0_QISR_DIR_Field is Interfaces.SAM.Bit;
   ...
   subtype TC0_FMR_ENCF_Element is Interfaces.SAM.Bit;
