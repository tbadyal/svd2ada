...
package Interfaces.SAM.USART is
   ...
   subtype USART0_CR_DTREN_Field is Interfaces.SAM.Bit;
   subtype USART0_CR_DTRDIS_Field is Interfaces.SAM.Bit;
   ...
   type USART0_CR_Register is record
      ...
      DTREN          : USART0_CR_DTREN_Field := 16#0#;
      --  Write-only. Data Terminal Ready Disable
      DTRDIS         : USART0_CR_DTRDIS_Field := 16#0#;
   ...
   subtype USART0_MR_VAR_SYNC_Field is Interfaces.SAM.Bit;
   ...
   subtype USART0_MR_MAN_Field is Interfaces.SAM.Bit;
   subtype USART0_MR_MODSYNC_Field is Interfaces.SAM.Bit;
   subtype USART0_MR_ONEBIT_Field is Interfaces.SAM.Bit;
   ...
   subtype USART0_IER_RIIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IER_DSRIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IER_DCDIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IER_CTSIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IER_MANE_Field is Interfaces.SAM.Bit;
   ...
   subtype USART0_IDR_RIIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IDR_DSRIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IDR_DCDIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IDR_CTSIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IDR_MANE_Field is Interfaces.SAM.Bit;
   ...
   subtype USART0_IMR_RIIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IMR_DSRIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IMR_DCDIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IMR_CTSIC_Field is Interfaces.SAM.Bit;
   subtype USART0_IMR_MANE_Field is Interfaces.SAM.Bit;
   ...
   subtype USART0_CSR_RIIC_Field is Interfaces.SAM.Bit;
   subtype USART0_CSR_DSRIC_Field is Interfaces.SAM.Bit;
   subtype USART0_CSR_DCDIC_Field is Interfaces.SAM.Bit;
   subtype USART0_CSR_CTSIC_Field is Interfaces.SAM.Bit;
   subtype USART0_CSR_RI_Field is Interfaces.SAM.Bit;
   subtype USART0_CSR_DSR_Field is Interfaces.SAM.Bit;
   subtype USART0_CSR_DCD_Field is Interfaces.SAM.Bit;
   subtype USART0_CSR_CTS_Field is Interfaces.SAM.Bit;
   subtype USART0_CSR_MANERR_Field is Interfaces.SAM.Bit;
   ...
   subtype USART0_RTOR_TO_Field is Interfaces.SAM.UInt16;
   ...
   subtype USART0_MAN_TX_MPOL_Field is Interfaces.SAM.Bit;
   ...
   subtype USART0_MAN_RX_MPOL_Field is Interfaces.SAM.Bit;
   subtype USART0_MAN_ONE_Field is Interfaces.SAM.Bit;
   subtype USART0_MAN_DRIFT_Field is Interfaces.SAM.Bit;
   ...
   subtype USART0_VERSION_VERSION_Field is Interfaces.SAM.UInt12;
   subtype USART0_VERSION_MFN_Field is Interfaces.SAM.UInt3;
