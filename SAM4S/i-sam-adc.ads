...
--  channel.
   ...
   type ADC_MR_Register is record
      ...
      --  Resolution
      LOWRES         : MR_LOWRES_Field := Interfaces.SAM.ADC.BITS_12;
      --  Sleep Mode
   ...
   subtype ADC_SEQR1_USCH1_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR1_USCH2_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR1_USCH3_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR1_USCH4_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR1_USCH5_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR1_USCH6_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR1_USCH7_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR1_USCH8_Field is Interfaces.SAM.UInt3;
   ...
   subtype ADC_SEQR2_USCH9_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR2_USCH10_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR2_USCH11_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR2_USCH12_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR2_USCH13_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR2_USCH14_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR2_USCH15_Field is Interfaces.SAM.UInt3;
   subtype ADC_SEQR2_USCH16_Field is Interfaces.SAM.UInt3;
   ...
   subtype ADC_LCDR_LDATA_Field is Interfaces.SAM.UInt12;
   subtype ADC_LCDR_CHNB_Field is Interfaces.SAM.UInt4;
   ...
   type ADC_IER_Register is record
      ...
      --  unspecified
      Reserved_16_22 : Interfaces.SAM.UInt7 := 16#0#;
...
--  threshold of the window.
   ...
   type ADC_EMR_Register is record
      ...
      --  unspecified
      Reserved_10_23 : Interfaces.SAM.UInt14 := 16#0#;
   ...
   subtype ADC_CWR_LOWTHRES_Field is Interfaces.SAM.UInt12;
   subtype ADC_CWR_HIGHTHRES_Field is Interfaces.SAM.UInt12;
   ...
   subtype ADC_CGR_GAIN_Element is Interfaces.SAM.UInt2;
   ...
   subtype ADC_CDR_DATA_Field is Interfaces.SAM.UInt12;
   ...
   subtype ADC_ACR_TSON_Field is Interfaces.SAM.Bit;
   subtype ADC_ACR_IBCTL_Field is Interfaces.SAM.UInt2;
   ...
   subtype ADC_WPMR_WPKEY_Field is Interfaces.SAM.UInt24;
