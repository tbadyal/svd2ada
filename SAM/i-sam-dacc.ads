...
package Interfaces.SAM.DACC is
   ...
   subtype DACC_CR_SWRST_Field is Interfaces.SAM.Bit;
   ...
   subtype DACC_MR_SLEEP_Field is Interfaces.SAM.Bit;
   subtype DACC_MR_FASTWKUP_Field is Interfaces.SAM.Bit;
...
--  conversion.
   ...
   subtype DACC_CHER_CH_Element is Interfaces.SAM.Bit;
   ...
   subtype DACC_CHDR_CH_Element is Interfaces.SAM.Bit;
   ...
   subtype DACC_CHSR_CH_Element is Interfaces.SAM.Bit;
   ...
   subtype DACC_IER_TXRDY_Field is Interfaces.SAM.Bit;
   subtype DACC_IER_EOC_Field is Interfaces.SAM.Bit;
   subtype DACC_IER_ENDTX_Field is Interfaces.SAM.Bit;
   subtype DACC_IER_TXBUFE_Field is Interfaces.SAM.Bit;
   ...
   subtype DACC_IDR_TXRDY_Field is Interfaces.SAM.Bit;
   subtype DACC_IDR_EOC_Field is Interfaces.SAM.Bit;
   subtype DACC_IDR_ENDTX_Field is Interfaces.SAM.Bit;
   subtype DACC_IDR_TXBUFE_Field is Interfaces.SAM.Bit;
   ...
   subtype DACC_IMR_TXRDY_Field is Interfaces.SAM.Bit;
   subtype DACC_IMR_EOC_Field is Interfaces.SAM.Bit;
   subtype DACC_IMR_ENDTX_Field is Interfaces.SAM.Bit;
   subtype DACC_IMR_TXBUFE_Field is Interfaces.SAM.Bit;
   ...
   subtype DACC_ISR_TXRDY_Field is Interfaces.SAM.Bit;
   subtype DACC_ISR_EOC_Field is Interfaces.SAM.Bit;
   subtype DACC_ISR_ENDTX_Field is Interfaces.SAM.Bit;
   subtype DACC_ISR_TXBUFE_Field is Interfaces.SAM.Bit;
   ...
   subtype DACC_WPMR_WPEN_Field is Interfaces.SAM.Bit;
   ...
   subtype DACC_WPSR_WPROTERR_Field is Interfaces.SAM.Bit;
   ...
   subtype DACC_PTCR_RXTEN_Field is Interfaces.SAM.Bit;
   subtype DACC_PTCR_RXTDIS_Field is Interfaces.SAM.Bit;
   subtype DACC_PTCR_TXTEN_Field is Interfaces.SAM.Bit;
   subtype DACC_PTCR_TXTDIS_Field is Interfaces.SAM.Bit;
   ...
   subtype DACC_PTSR_RXTEN_Field is Interfaces.SAM.Bit;
   subtype DACC_PTSR_TXTEN_Field is Interfaces.SAM.Bit;
