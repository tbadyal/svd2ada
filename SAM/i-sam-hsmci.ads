...
--  transfer.Values from 0x200 to 0xFFFF are forbidden.
   ...
   subtype HSMCI_SR_SDIOIRQforSlotA_Field is Interfaces.SAM.Bit;
   subtype HSMCI_SR_SDIOIRQforSlotB_Field is Interfaces.SAM.Bit;
   ...
   subtype HSMCI_SR_BLKOVRE_Field is Interfaces.SAM.Bit;
   subtype HSMCI_SR_DMADONE_Field is Interfaces.SAM.Bit;
   ...
   subtype HSMCI_IER_SDIOIRQforSlotA_Field is Interfaces.SAM.Bit;
   subtype HSMCI_IER_SDIOIRQforSlotB_Field is Interfaces.SAM.Bit;
   ...
   subtype HSMCI_IER_BLKOVRE_Field is Interfaces.SAM.Bit;
   subtype HSMCI_IER_DMADONE_Field is Interfaces.SAM.Bit;
   ...
   subtype HSMCI_IDR_SDIOIRQforSlotA_Field is Interfaces.SAM.Bit;
   subtype HSMCI_IDR_SDIOIRQforSlotB_Field is Interfaces.SAM.Bit;
   ...
   subtype HSMCI_IDR_BLKOVRE_Field is Interfaces.SAM.Bit;
   subtype HSMCI_IDR_DMADONE_Field is Interfaces.SAM.Bit;
   ...
   subtype HSMCI_IMR_SDIOIRQforSlotA_Field is Interfaces.SAM.Bit;
   subtype HSMCI_IMR_SDIOIRQforSlotB_Field is Interfaces.SAM.Bit;
   ...
   subtype HSMCI_IMR_BLKOVRE_Field is Interfaces.SAM.Bit;
   subtype HSMCI_IMR_DMADONE_Field is Interfaces.SAM.Bit;
   ...
   subtype HSMCI_DMA_DMAEN_Field is Interfaces.SAM.Bit;
   subtype HSMCI_DMA_ROPT_Field is Interfaces.SAM.Bit;
