...
package Interfaces.SAM.PWM is
   ...
   subtype PWM_CLK_DIVA_Field is Interfaces.SAM.Byte;
   subtype PWM_CLK_PREA_Field is Interfaces.SAM.UInt4;
   subtype PWM_CLK_DIVB_Field is Interfaces.SAM.Byte;
   subtype PWM_CLK_PREB_Field is Interfaces.SAM.UInt4;
...
--  update of synchronous channels
   ...
   type PWM_SCM_Register is record
      ...
      Reserved_8_15  : Interfaces.SAM.Byte := 16#0#;
      --  Synchronous Channels Update Mode
      UPDM           : SCM_UPDM_Field := Interfaces.SAM.PWM.MODE0;
      --  unspecified
   ...
   subtype PWM_IER2_ENDTX_Field is Interfaces.SAM.Bit;
   subtype PWM_IER2_TXBUFE_Field is Interfaces.SAM.Bit;
   ...
   subtype PWM_IDR2_ENDTX_Field is Interfaces.SAM.Bit;
   subtype PWM_IDR2_TXBUFE_Field is Interfaces.SAM.Bit;
   ...
   subtype PWM_IMR2_ENDTX_Field is Interfaces.SAM.Bit;
   subtype PWM_IMR2_TXBUFE_Field is Interfaces.SAM.Bit;
   ...
   subtype PWM_ISR2_ENDTX_Field is Interfaces.SAM.Bit;
   subtype PWM_ISR2_TXBUFE_Field is Interfaces.SAM.Bit;
   ...
   subtype PWM_OSCUPD_OSCUPDL6_Field is Interfaces.SAM.Bit;
   subtype PWM_OSCUPD_OSCUPL7_Field is Interfaces.SAM.Bit;
   ...
   subtype PWM_FPV_FPVH_Element is Interfaces.SAM.Bit;
   ...
   subtype PWM_FPV_FPVL_Element is Interfaces.SAM.Bit;
   ...
   subtype PWM_FPE1_FPE_Element is Interfaces.SAM.Byte;
   ...
   subtype PWM_FPE2_FPE_Element is Interfaces.SAM.Byte;
   ...
   subtype PWM_WPCR_WPCMD_Field is Interfaces.SAM.UInt2;
   ...
   subtype PWM_WPCR_WPKEY_Field is Interfaces.SAM.UInt24;
   ...
   subtype PWM_TCR_TXCTR_Field is Interfaces.SAM.UInt16;
   ...
   subtype PWM_TNCR_TXNCTR_Field is Interfaces.SAM.UInt16;
   ...
   subtype PWM_PTCR_RXTEN_Field is Interfaces.SAM.Bit;
   subtype PWM_PTCR_RXTDIS_Field is Interfaces.SAM.Bit;
   subtype PWM_PTCR_TXTEN_Field is Interfaces.SAM.Bit;
   subtype PWM_PTCR_TXTDIS_Field is Interfaces.SAM.Bit;
   ...
   subtype PWM_PTSR_RXTEN_Field is Interfaces.SAM.Bit;
   subtype PWM_PTSR_TXTEN_Field is Interfaces.SAM.Bit;
   ...
   subtype CMPV_CV_Field is Interfaces.SAM.UInt24;
   subtype CMPV_CVM_Field is Interfaces.SAM.Bit;
   ...
   subtype CMPVUPD_CVUPD_Field is Interfaces.SAM.UInt24;
   subtype CMPVUPD_CVMUPD_Field is Interfaces.SAM.Bit;
   ...
   subtype CMPM_CEN_Field is Interfaces.SAM.Bit;
   subtype CMPM_CTR_Field is Interfaces.SAM.UInt4;
   subtype CMPM_CPR_Field is Interfaces.SAM.UInt4;
   subtype CMPM_CPRCNT_Field is Interfaces.SAM.UInt4;
   subtype CMPM_CUPR_Field is Interfaces.SAM.UInt4;
   subtype CMPM_CUPRCNT_Field is Interfaces.SAM.UInt4;
   ...
   subtype CMPMUPD_CENUPD_Field is Interfaces.SAM.Bit;
   subtype CMPMUPD_CTRUPD_Field is Interfaces.SAM.UInt4;
   subtype CMPMUPD_CPRUPD_Field is Interfaces.SAM.UInt4;
   subtype CMPMUPD_CUPRUPD_Field is Interfaces.SAM.UInt4;
   ...
   subtype CMR_CALG_Field is Interfaces.SAM.Bit;
   subtype CMR_CPOL_Field is Interfaces.SAM.Bit;
   subtype CMR_CES_Field is Interfaces.SAM.Bit;
   subtype CMR_DTE_Field is Interfaces.SAM.Bit;
   subtype CMR_DTHI_Field is Interfaces.SAM.Bit;
   subtype CMR_DTLI_Field is Interfaces.SAM.Bit;

   --  PWM Channel Mode Register (ch_num = 0)
   type CMR_Register is record
      --  Channel Pre-scaler
      CPRE           : CMR0_CPRE_Field := Interfaces.SAM.PWM.MCK;
      --  unspecified
      Reserved_4_7   : Interfaces.SAM.UInt4 := 16#0#;
      --  Channel Alignment
   ...
   subtype CDTY_CDTY_Field is Interfaces.SAM.UInt24;
   ...
   subtype CDTYUPD_CDTYUPD_Field is Interfaces.SAM.UInt24;
   ...
   subtype CPRD_CPRD_Field is Interfaces.SAM.UInt24;
   ...
   subtype CPRDUPD_CPRDUPD_Field is Interfaces.SAM.UInt24;
   ...
   subtype CCNT_CNT_Field is Interfaces.SAM.UInt24;
   ...
   subtype DT_DTH_Field is Interfaces.SAM.UInt16;
   subtype DT_DTL_Field is Interfaces.SAM.UInt16;
   ...
   subtype DTUPD_DTHUPD_Field is Interfaces.SAM.UInt16;
   subtype DTUPD_DTLUPD_Field is Interfaces.SAM.UInt16;
