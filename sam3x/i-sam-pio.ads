...
package Interfaces.SAM.PIO is
   ...
   subtype PIOA_ABSR_P_Element is Interfaces.SAM.Bit;
   ...
   subtype PIOA_SCIFSR_P_Element is Interfaces.SAM.Bit;
   ...
   subtype PIOA_DIFSR_P_Element is Interfaces.SAM.Bit;
   ...
   subtype PIOA_IFDGSR_P_Element is Interfaces.SAM.Bit;
