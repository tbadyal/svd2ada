...
--  DMA Controller
package Interfaces.SAM.DMAC is
   pragma Preelaborate;
   ...
   type DMAC_GCFG_Register is record
      ...
      --  Arbiter Configuration
      ARB_CFG       : GCFG_ARB_CFG_Field := Interfaces.SAM.DMAC.ROUND_ROBIN;
      --  unspecified
   ...
   subtype DMAC_EN_ENABLE_Field is Interfaces.SAM.Bit;
   ...
   subtype DMAC_SREQ_SSREQ0_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_DSREQ0_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_SSREQ1_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_DSREQ1_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_SSREQ2_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_DSREQ2_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_SSREQ3_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_DSREQ3_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_SSREQ4_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_DSREQ4_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_SSREQ5_Field is Interfaces.SAM.Bit;
   subtype DMAC_SREQ_DSREQ5_Field is Interfaces.SAM.Bit;
   ...
   subtype DMAC_CREQ_SCREQ0_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_DCREQ0_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_SCREQ1_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_DCREQ1_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_SCREQ2_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_DCREQ2_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_SCREQ3_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_DCREQ3_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_SCREQ4_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_DCREQ4_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_SCREQ5_Field is Interfaces.SAM.Bit;
   subtype DMAC_CREQ_DCREQ5_Field is Interfaces.SAM.Bit;
   ...
   subtype DMAC_LAST_SLAST0_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_DLAST0_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_SLAST1_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_DLAST1_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_SLAST2_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_DLAST2_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_SLAST3_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_DLAST3_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_SLAST4_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_DLAST4_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_SLAST5_Field is Interfaces.SAM.Bit;
   subtype DMAC_LAST_DLAST5_Field is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCIER_BTC_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCIER_CBTC_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCIER_ERR_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCIDR_BTC_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCIDR_CBTC_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCIDR_ERR_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCIMR_BTC_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCIMR_CBTC_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCIMR_ERR_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCISR_BTC_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCISR_CBTC_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_EBCISR_ERR_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_CHER_ENA_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_CHER_SUSP_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_CHER_KEEP_Element is Interfaces.SAM.Bit;
   ...
   type DMAC_CHER_Register is record
      ...
      SUSP           : DMAC_CHER_SUSP_Field :=
                        (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_14_23 : Interfaces.SAM.UInt10 := 16#0#;
   ...
   subtype DMAC_CHDR_DIS_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_CHDR_RES_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_CHSR_ENA_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_CHSR_SUSP_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_CHSR_EMPT_Element is Interfaces.SAM.Bit;
   ...
   subtype DMAC_CHSR_STAL_Element is Interfaces.SAM.Bit;
   ...
   subtype DSCR_DSCR_Field is Interfaces.SAM.UInt30;
   ...
   subtype CTRLA_BTSIZE_Field is Interfaces.SAM.UInt16;
   ...
   subtype CTRLA_DONE_Field is Interfaces.SAM.Bit;
   ...
   type CTRLA_Register is record
      ...
      --  Source Chunk Transfer Size.
      SCSIZE         : CTRLA0_SCSIZE_Field := Interfaces.SAM.DMAC.CHK_1;
      --  unspecified
      Reserved_19_19 : Interfaces.SAM.Bit := 16#0#;
      --  Destination Chunk Transfer Size
      DCSIZE         : CTRLA0_DCSIZE_Field := Interfaces.SAM.DMAC.CHK_1;
      --  unspecified
      Reserved_23_23 : Interfaces.SAM.Bit := 16#0#;
      --  Transfer Width for the Source
      SRC_WIDTH      : CTRLA0_SRC_WIDTH_Field := Interfaces.SAM.DMAC.BYTE;
      --  unspecified
      Reserved_26_27 : Interfaces.SAM.UInt2 := 16#0#;
      --  Transfer Width for the Destination
      DST_WIDTH      : CTRLA0_DST_WIDTH_Field := Interfaces.SAM.DMAC.BYTE;
      --  unspecified
...
--  memory.
   ...
   subtype CTRLB_IEN_Field is Interfaces.SAM.Bit;
   ...
   type CTRLB_Register is record
      ...
      SRC_DSCR       : CTRLB0_SRC_DSCR_Field :=
                        Interfaces.SAM.DMAC.FETCH_FROM_MEM;
      --  unspecified
      ...
      DST_DSCR       : CTRLB0_DST_DSCR_Field :=
                        Interfaces.SAM.DMAC.FETCH_FROM_MEM;
      --  Flow Control
      FC             : CTRLB0_FC_Field := Interfaces.SAM.DMAC.MEM2MEM_DMA_FC;
      --  Incrementing, Decrementing or Fixed Address for the Source
      SRC_INCR       : CTRLB0_SRC_INCR_Field :=
                        Interfaces.SAM.DMAC.INCREMENTING;
      --  unspecified
      Reserved_26_27 : Interfaces.SAM.UInt2 := 16#0#;
      --  Incrementing, Decrementing or Fixed Address for the Destination
   ...
   subtype CFG_SRC_PER_Field is Interfaces.SAM.UInt4;
   subtype CFG_DST_PER_Field is Interfaces.SAM.UInt4;
...
--  transfer.
   ...
   subtype CFG_AHB_PROT_Field is Interfaces.SAM.UInt3;
...
--  then the request is serviced.
   ...
   type CFG_Register is record
      ...
      --  Software or Hardware Selection for the Source
      SRC_H2SEL      : CFG0_SRC_H2SEL_Field := Interfaces.SAM.DMAC.SW;
      --  unspecified
      Reserved_10_12 : Interfaces.SAM.UInt3 := 16#0#;
      --  Software or Hardware Selection for the Destination
      DST_H2SEL      : CFG0_DST_H2SEL_Field := Interfaces.SAM.DMAC.SW;
      --  unspecified
      Reserved_14_15 : Interfaces.SAM.UInt2 := 16#0#;
      --  Stop On Done
      SOD            : CFG0_SOD_Field := Interfaces.SAM.DMAC.DISABLE;
      --  unspecified
      Reserved_17_19 : Interfaces.SAM.UInt3 := 16#0#;
      --  Interface Lock
      LOCK_IF        : CFG0_LOCK_IF_Field := Interfaces.SAM.DMAC.DISABLE;
      --  Bus Lock
      LOCK_B         : CFG0_LOCK_B_Field := Interfaces.SAM.DMAC.DISABLE;
      --  Master Interface Arbiter Lock
      LOCK_IF_L      : CFG0_LOCK_IF_L_Field := Interfaces.SAM.DMAC.CHUNK;
      --  unspecified
      Reserved_23_23 : Interfaces.SAM.Bit := 16#0#;
      --  AHB Protection
      ...
      --  FIFO Configuration
      FIFOCFG        : CFG0_FIFOCFG_Field := Interfaces.SAM.DMAC.ALAP_CFG;
      --  unspecified
      Reserved_30_31 : Interfaces.SAM.UInt2 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype DMAC_WPMR_WPEN_Field is Interfaces.SAM.Bit;
   subtype DMAC_WPMR_WPKEY_Field is Interfaces.SAM.UInt24;
   ...
   subtype DMAC_WPSR_WPVS_Field is Interfaces.SAM.Bit;
   subtype DMAC_WPSR_WPVSRC_Field is Interfaces.SAM.UInt16;
   ...
   type DMAC_Peripheral is record
      ...
      SADDR0 : aliased Interfaces.SAM.UInt32;
      --  DMAC Channel Destination Address Register (ch_num = 0)
      DADDR0 : aliased Interfaces.SAM.UInt32;
      --  DMAC Channel Descriptor Address Register (ch_num = 0)
      ...
      SADDR1 : aliased Interfaces.SAM.UInt32;
      --  DMAC Channel Destination Address Register (ch_num = 1)
      DADDR1 : aliased Interfaces.SAM.UInt32;
      ...
      SADDR2 : aliased Interfaces.SAM.UInt32;
      --  DMAC Channel Destination Address Register (ch_num = 2)
      DADDR2 : aliased Interfaces.SAM.UInt32;
      ...
      SADDR3 : aliased Interfaces.SAM.UInt32;
      --  DMAC Channel Destination Address Register (ch_num = 3)
      DADDR3 : aliased Interfaces.SAM.UInt32;
      ...
      SADDR4 : aliased Interfaces.SAM.UInt32;
      --  DMAC Channel Destination Address Register (ch_num = 4)
      DADDR4 : aliased Interfaces.SAM.UInt32;
      ...
      SADDR5 : aliased Interfaces.SAM.UInt32;
      --  DMAC Channel Destination Address Register (ch_num = 5)
      DADDR5 : aliased Interfaces.SAM.UInt32;
