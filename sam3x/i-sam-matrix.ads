...
package Interfaces.SAM.MATRIX is
   ...
   subtype MATRIX_PRAS_M5PR_Field is Interfaces.SAM.UInt2;
   ...
   subtype MATRIX_MRCR_RCB4_Field is Interfaces.SAM.UInt2;
   subtype MATRIX_MRCR_RCB5_Field is Interfaces.SAM.Bit;
   ...
   subtype CCFG_SYSIO_SYSIO12_Field is Interfaces.SAM.Bit;
